...
class GoogledriveCreateToolInput(BaseModel):
    ...
    driveId: Optional[Dict[str, Any]] = Field(None, description="The drive where to create the new folder")
    folderId: Optional[Dict[str, Any]] = Field(None, description="The parent folder where to create the new folder")
...
class GoogledriveCreateTool(BaseTool):
    name = "googledrive_create"
    description = "Tool for googleDrive create operation - create operation"
    
    def _run(self, **kwargs):
        """Run the googleDrive create operation."""
        # Implement the tool logic here
        return f"Running googleDrive create operation with args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the googleDrive create operation asynchronously."""
