...
class BoxShareToolInput(BaseModel):
    ...
    fileId: Optional[str] = Field(None, description="The ID of the file to share")
    ...
    folderId: Optional[str] = Field(None, description="The ID of the folder to share")
...
class BoxShareTool(BaseTool):
    name = "box_share"
    description = "Tool for box share operation - share operation"
    
    def _run(self, **kwargs):
        """Run the box share operation."""
        # Implement the tool logic here
        return f"Running box share operation with args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the box share operation asynchronously."""
