...
class SlackHistoryToolInput(BaseModel):
    ...
    channelId: Optional[Dict[str, Any]] = Field(None, description="The Slack channel to get the history from")
...
class SlackHistoryTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running slack history operation with args: {kwargs}"
