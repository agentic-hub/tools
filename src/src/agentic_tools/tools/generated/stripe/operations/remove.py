...
class StripeRemoveToolInput(BaseModel):
    ...
    customerId: Optional[str] = Field(None, description="ID of the customer whose card to remove")
    ...
    cardId: Optional[str] = Field(None, description="ID of the card to remove")
...
class StripeRemoveTool(BaseTool):
    name = "stripe_remove"
    description = "Tool for stripe remove operation - remove operation"
    
    def _run(self, **kwargs):
        """Run the stripe remove operation."""
        # Implement the tool logic here
        return f"Running stripe remove operation with args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the stripe remove operation asynchronously."""
