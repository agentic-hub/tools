...
class KobotoolboxRetryoneToolInput(BaseModel):
    ...
    logId: Optional[str] = Field(None, description="Hook log ID (starts with hl, e.g. hlSbGKaUKzTVNoWEVMYbLHe)")
...
class KobotoolboxRetryoneTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running koBoToolbox retryOne operation with args: {kwargs}"
