...
class ThehiveprojectSearchToolInput(BaseModel):
    ...
    allTasks: Optional[bool] = Field(None, description="Whether to search in all tasks or only in selected task")
    ...
    searchInKnowledgeBase: Optional[bool] = Field(None, description="Whether to search in knowledge base or only in the selected case")
    id: Optional[Dict[str, Any]] = Field(None, description="Alert")
    allCases: Optional[bool] = Field(None, description="Whether to search in all cases or only in a selected case")
...
class ThehiveprojectSearchTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running theHiveProject search operation with args: {kwargs}"
