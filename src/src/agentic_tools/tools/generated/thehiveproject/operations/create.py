...
class ThehiveprojectCreateToolInput(BaseModel):
    ...
    createIn: Optional[str] = Field(None, description="Create in")
    ...
    observableUi: Optional[Dict[str, Any]] = Field(None, description="Observables")
...
class ThehiveprojectCreateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running theHiveProject create operation with args: {kwargs}"
