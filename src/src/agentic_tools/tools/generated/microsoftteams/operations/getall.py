...
class MicrosoftteamsGetallToolInput(BaseModel):
    ...
    tasksFor: Optional[str] = Field(None, description="Whether to retrieve the tasks for a user or for a plan")
...
class MicrosoftteamsGetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running microsoftTeams getAll operation with args: {kwargs}"
