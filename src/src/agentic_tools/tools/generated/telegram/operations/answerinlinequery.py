...
class TelegramAnswerinlinequeryToolInput(BaseModel):
    ...
    queryId: Optional[str] = Field(None, description="Unique identifier for the answered query")
...
class TelegramAnswerinlinequeryTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running telegram answerInlineQuery operation with args: {kwargs}"
