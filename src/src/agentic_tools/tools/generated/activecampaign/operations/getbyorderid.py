...
class ActivecampaignGetbyorderidToolInput(BaseModel):
    ...
    orderId: Optional[float] = Field(None, description="The ID of the order whose products you'd like returned")
...
class ActivecampaignGetbyorderidTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running activeCampaign getByOrderId operation with args: {kwargs}"
