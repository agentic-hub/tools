...
class ActivecampaignGetbyproductidToolInput(BaseModel):
    ...
    procuctId: Optional[float] = Field(None, description="The ID of the product you'd like returned")
...
class ActivecampaignGetbyproductidTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running activeCampaign getByProductId operation with args: {kwargs}"
