...
class GooglefirebasecloudfirestoreUpsertToolInput(BaseModel):
    updateKey: Optional[str] = Field(None, description="Must correspond to a document ID")
...
class GooglefirebasecloudfirestoreUpsertTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running googleFirebaseCloudFirestore upsert operation with args: {kwargs}"
