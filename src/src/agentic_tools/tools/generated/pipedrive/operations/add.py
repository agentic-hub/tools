...
class PipedriveAddToolInput(BaseModel):
    ...
    dealId: Optional[str] = Field(None, description="The ID of the deal to add a product to. Choose from the list, or specify an ID using an <a href=\"https://docs.n8n.io/code-examples/expressions/\">expression</a>.")
    ...
    productId: Optional[str] = Field(None, description="The ID of the product to add to a deal. Choose from the list, or specify an ID using an <a href=\"https://docs.n8n.io/code-examples/expressions/\">expression</a>.")
...
class PipedriveAddTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running pipedrive add operation with args: {kwargs}"
