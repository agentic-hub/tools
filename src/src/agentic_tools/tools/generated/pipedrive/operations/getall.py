...
class PipedriveGetallToolInput(BaseModel):
    ...
    dealId: Optional[str] = Field(None, description="The ID of the deal whose products to retrieve. Choose from the list, or specify an ID using an <a href=\"https://docs.n8n.io/code-examples/expressions/\">expression</a>.")
...
class PipedriveGetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running pipedrive getAll operation with args: {kwargs}"
