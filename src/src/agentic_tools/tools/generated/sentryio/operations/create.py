...
class SentryioCreateToolInput(BaseModel):
    ...
    agreeTerms: Optional[bool] = Field(None, description="Whether you agree to the applicable terms of service and privacy policy of Sentry.io")
...
class SentryioCreateTool(BaseTool):
    name = "sentryio_create"
    description = "Tool for sentryIo create operation - create operation"
    
    def _run(self, **kwargs):
        """Run the sentryIo create operation."""
        # Implement the tool logic here
        return f"Running sentryIo create operation with args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the sentryIo create operation asynchronously."""
