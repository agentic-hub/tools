...
class MondaycomGetbycolumnvalueTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mondayCom getByColumnValue operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mondayCom getByColumnValue operation with default credentials and args: {kwargs}"
