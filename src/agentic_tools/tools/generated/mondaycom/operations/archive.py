...
class MondaycomArchiveTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mondayCom archive operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mondayCom archive operation with default credentials and args: {kwargs}"
