...
class Thehive__custom_api_call__ToolInput(BaseModel):
...
class Thehive__custom_api_call__Tool(BaseTool):
    name = "thehive___custom_api_call__"
    description = "Tool for theHive __CUSTOM_API_CALL__ operation - __CUSTOM_API_CALL__ operation"
    ...
    def _run(self, **kwargs):
        """Run the theHive __CUSTOM_API_CALL__ operation."""
        ...
        if credentials:
            ...
            return f"Running theHive __CUSTOM_API_CALL__ operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHive __CUSTOM_API_CALL__ operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHive __CUSTOM_API_CALL__ operation asynchronously."""
