...
class ThehiveExecuteresponderTool(BaseTool):
    name = "thehive_executeresponder"
    description = "Tool for theHive executeResponder operation - executeResponder operation"
    ...
    def _run(self, **kwargs):
        """Run the theHive executeResponder operation."""
        ...
        if credentials:
            ...
            return f"Running theHive executeResponder operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHive executeResponder operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHive executeResponder operation asynchronously."""
