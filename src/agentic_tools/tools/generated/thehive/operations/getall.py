...
class ThehiveGetallTool(BaseTool):
    name = "thehive_getall"
    description = "Tool for theHive getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the theHive getAll operation."""
        ...
        if credentials:
            ...
            return f"Running theHive getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHive getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHive getAll operation asynchronously."""
