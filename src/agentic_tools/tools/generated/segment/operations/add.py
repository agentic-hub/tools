...
class SegmentAddTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running segment add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running segment add operation with default credentials and args: {kwargs}"
