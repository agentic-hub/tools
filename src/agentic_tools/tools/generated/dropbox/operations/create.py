...
class DropboxCreateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running dropbox create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running dropbox create operation with default credentials and args: {kwargs}"
