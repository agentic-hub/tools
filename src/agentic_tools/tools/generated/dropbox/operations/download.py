...
class DropboxDownloadTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running dropbox download operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running dropbox download operation with default credentials and args: {kwargs}"
