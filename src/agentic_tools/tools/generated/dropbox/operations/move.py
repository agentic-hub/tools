...
class DropboxMoveTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running dropbox move operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running dropbox move operation with default credentials and args: {kwargs}"
