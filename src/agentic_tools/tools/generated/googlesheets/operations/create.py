...
class GooglesheetsCreateTool(BaseTool):
    ...
    description = "Tool for googleSheets create operation - create operation"
    ...
    def _run(self, **kwargs):
        """Run the googleSheets create operation."""
        ...
        if credentials:
            ...
            return f"Running googleSheets create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleSheets create operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the googleSheets create operation asynchronously."""
