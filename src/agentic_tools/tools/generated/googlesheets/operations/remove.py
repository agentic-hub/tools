...
class GooglesheetsRemoveTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running googleSheets remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleSheets remove operation with default credentials and args: {kwargs}"
