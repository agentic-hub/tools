...
class GooglesheetsDeletespreadsheetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running googleSheets deleteSpreadsheet operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleSheets deleteSpreadsheet operation with default credentials and args: {kwargs}"
