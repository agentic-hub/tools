...
class GooglesheetsAppendorupdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running googleSheets appendOrUpdate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleSheets appendOrUpdate operation with default credentials and args: {kwargs}"
