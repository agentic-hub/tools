...
class GooglesheetsUpdateToolInput(BaseModel):
...
class GooglesheetsUpdateTool(BaseTool):
    name = "googlesheets_update"
    description = "Tool for googleSheets update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the googleSheets update operation."""
        ...
        if credentials:
            ...
            return f"Running googleSheets update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleSheets update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the googleSheets update operation asynchronously."""
