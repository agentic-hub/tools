...
class AutomizyGetallTool(BaseTool):
    name = "automizy_getall"
    description = "Tool for automizy getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the automizy getAll operation."""
        ...
        if credentials:
            ...
            return f"Running automizy getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running automizy getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the automizy getAll operation asynchronously."""
