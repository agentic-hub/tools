...
class GitlabGetrepositoriesTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running gitlab getRepositories operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running gitlab getRepositories operation with default credentials and args: {kwargs}"
