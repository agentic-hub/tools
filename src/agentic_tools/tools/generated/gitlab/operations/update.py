...
class GitlabUpdateTool(BaseTool):
    name = "gitlab_update"
    description = "Tool for gitlab update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the gitlab update operation."""
        ...
        if credentials:
            ...
            return f"Running gitlab update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running gitlab update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the gitlab update operation asynchronously."""
