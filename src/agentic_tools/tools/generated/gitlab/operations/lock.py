...
class GitlabLockTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running gitlab lock operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running gitlab lock operation with default credentials and args: {kwargs}"
