...
class AwscertificatemanagerGetmetadataTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running awsCertificateManager getMetadata operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running awsCertificateManager getMetadata operation with default credentials and args: {kwargs}"
