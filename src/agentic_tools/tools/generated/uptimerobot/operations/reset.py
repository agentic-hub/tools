...
class UptimerobotResetTool(BaseTool):
    name = "uptimerobot_reset"
    description = "Tool for uptimeRobot reset operation - reset operation"
    ...
    def _run(self, **kwargs):
        """Run the uptimeRobot reset operation."""
        ...
        if credentials:
            ...
            return f"Running uptimeRobot reset operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running uptimeRobot reset operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the uptimeRobot reset operation asynchronously."""
