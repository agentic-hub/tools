...
class UptimerobotGetallTool(BaseTool):
    name = "uptimerobot_getall"
    description = "Tool for uptimeRobot getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the uptimeRobot getAll operation."""
        ...
        if credentials:
            ...
            return f"Running uptimeRobot getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running uptimeRobot getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the uptimeRobot getAll operation asynchronously."""
