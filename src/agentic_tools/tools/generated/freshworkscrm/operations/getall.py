...
class FreshworkscrmGetallTool(BaseTool):
    name: str = "freshworkscrm_getall"
    description: str = "Tool for freshworksCrm getAll operation - getAll operation"
    args_schema: type[BaseModel] | None = FreshworkscrmGetallToolInput
