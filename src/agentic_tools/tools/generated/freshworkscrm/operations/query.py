...
class FreshworkscrmQueryTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running freshworksCrm query operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running freshworksCrm query operation with default credentials and args: {kwargs}"
