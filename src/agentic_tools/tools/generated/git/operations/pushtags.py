...
class GitPushtagsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running git pushTags operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running git pushTags operation with default credentials and args: {kwargs}"
