...
class GitPushTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running git push operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running git push operation with default credentials and args: {kwargs}"
