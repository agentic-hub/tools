...
class TwitterAddTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running twitter add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running twitter add operation with default credentials and args: {kwargs}"
