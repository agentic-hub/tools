...
class TwitterSearchuserTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running twitter searchUser operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running twitter searchUser operation with default credentials and args: {kwargs}"
