...
class EmeliaPauseTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running emelia pause operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running emelia pause operation with default credentials and args: {kwargs}"
