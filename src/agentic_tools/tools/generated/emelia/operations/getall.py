...
class EmeliaGetallToolInput(BaseModel):
...
class EmeliaGetallTool(BaseTool):
    name = "emelia_getall"
    description = "Tool for emelia getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the emelia getAll operation."""
        ...
        if credentials:
            ...
            return f"Running emelia getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running emelia getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the emelia getAll operation asynchronously."""
