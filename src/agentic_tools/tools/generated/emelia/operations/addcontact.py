...
class EmeliaAddcontactTool(BaseTool):
    name = "emelia_addcontact"
    description = "Tool for emelia addContact operation - addContact operation"
    ...
    def _run(self, **kwargs):
        """Run the emelia addContact operation."""
        ...
        if credentials:
            ...
            return f"Running emelia addContact operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running emelia addContact operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the emelia addContact operation asynchronously."""
