...
class YoutubeUploadTool(BaseTool):
    name = "youtube_upload"
    description = "Tool for youTube upload operation - upload operation"
    ...
    def _run(self, **kwargs):
        """Run the youTube upload operation."""
        ...
        if credentials:
            ...
            return f"Running youTube upload operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running youTube upload operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the youTube upload operation asynchronously."""
