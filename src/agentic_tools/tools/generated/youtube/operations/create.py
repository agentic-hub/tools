...
class YoutubeCreateToolInput(BaseModel):
...
class YoutubeCreateTool(BaseTool):
    name = "youtube_create"
    description = "Tool for youTube create operation - create operation"
    ...
    def _run(self, **kwargs):
        """Run the youTube create operation."""
        ...
        if credentials:
            ...
            return f"Running youTube create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running youTube create operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the youTube create operation asynchronously."""
