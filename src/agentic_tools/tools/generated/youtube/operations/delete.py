...
class YoutubeDeleteTool(BaseTool):
    name = "youtube_delete"
    description = "Tool for youTube delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the youTube delete operation."""
        ...
        if credentials:
            ...
            return f"Running youTube delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running youTube delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the youTube delete operation asynchronously."""
