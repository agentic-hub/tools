...
class YoutubeGetToolInput(BaseModel):
...
class YoutubeGetTool(BaseTool):
    name = "youtube_get"
    description = "Tool for youTube get operation - get operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running youTube get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running youTube get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the youTube get operation asynchronously."""
