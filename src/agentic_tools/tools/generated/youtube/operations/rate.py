...
class YoutubeRateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running youTube rate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running youTube rate operation with default credentials and args: {kwargs}"
