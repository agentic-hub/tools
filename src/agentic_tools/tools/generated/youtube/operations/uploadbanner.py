...
class YoutubeUploadbannerTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running youTube uploadBanner operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running youTube uploadBanner operation with default credentials and args: {kwargs}"
