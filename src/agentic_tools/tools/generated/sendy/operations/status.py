...
class SendyStatusTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running sendy status operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running sendy status operation with default credentials and args: {kwargs}"
