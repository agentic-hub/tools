...
class NpmGetversionsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running npm getVersions operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running npm getVersions operation with default credentials and args: {kwargs}"
