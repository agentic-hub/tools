...
class NpmUpdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running npm update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running npm update operation with default credentials and args: {kwargs}"
