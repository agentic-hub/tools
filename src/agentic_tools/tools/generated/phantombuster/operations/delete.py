...
class PhantombusterDeleteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running phantombuster delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running phantombuster delete operation with default credentials and args: {kwargs}"
