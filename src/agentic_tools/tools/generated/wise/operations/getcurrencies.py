...
class WiseGetcurrenciesToolInput(BaseModel):
...
class WiseGetcurrenciesTool(BaseTool):
    name = "wise_getcurrencies"
    description = "Tool for wise getCurrencies operation - getCurrencies operation"
    ...
    def _run(self, **kwargs):
        """Run the wise getCurrencies operation."""
        ...
        if credentials:
            ...
            return f"Running wise getCurrencies operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running wise getCurrencies operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the wise getCurrencies operation asynchronously."""
