...
class WiseGetbalancesTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running wise getBalances operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running wise getBalances operation with default credentials and args: {kwargs}"
