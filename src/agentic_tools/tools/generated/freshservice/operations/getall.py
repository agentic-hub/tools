...
class FreshserviceGetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running freshservice getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running freshservice getAll operation with default credentials and args: {kwargs}"
