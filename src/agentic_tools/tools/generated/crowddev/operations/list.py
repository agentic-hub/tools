...
class CrowddevListTool(BaseTool):
    name = "crowddev_list"
    description = "Tool for crowdDev list operation - list operation"
    ...
    def _run(self, **kwargs):
        """Run the crowdDev list operation."""
        ...
        if credentials:
            ...
            return f"Running crowdDev list operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running crowdDev list operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the crowdDev list operation asynchronously."""
