...
class CrowddevDeleteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running crowdDev delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running crowdDev delete operation with default credentials and args: {kwargs}"
