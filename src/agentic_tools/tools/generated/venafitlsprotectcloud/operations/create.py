...
class VenafitlsprotectcloudCreateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running venafiTlsProtectCloud create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running venafiTlsProtectCloud create operation with default credentials and args: {kwargs}"
