...
class CiscowebexUpdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running ciscoWebex update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running ciscoWebex update operation with default credentials and args: {kwargs}"
