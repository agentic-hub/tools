...
class CiscowebexDeleteTool(BaseTool):
    name = "ciscowebex_delete"
    description = "Tool for ciscoWebex delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the ciscoWebex delete operation."""
        ...
        if credentials:
            ...
            return f"Running ciscoWebex delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running ciscoWebex delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the ciscoWebex delete operation asynchronously."""
