...
class SlackHistoryToolInput(BaseModel):
    ...
    channel_id: Optional[Dict[str, Any]] = Field(None, description="The Slack channel to get the history from")
...
class SlackHistoryTool(BaseTool):
    name = "slack_history"
    description = "Tool for slack history operation - history operation"
    ...
    def _run(self, **kwargs):
        """Run the slack history operation."""
        ...
        if credentials:
            ...
            return f"Running slack history operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack history operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack history operation asynchronously."""
