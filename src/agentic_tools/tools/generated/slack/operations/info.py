...
class SlackInfoToolInput(BaseModel):
...
class SlackInfoTool(BaseTool):
    name = "slack_info"
    description = "Tool for slack info operation - info operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running slack info operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack info operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack info operation asynchronously."""
