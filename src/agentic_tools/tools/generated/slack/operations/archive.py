...
class SlackArchiveToolInput(BaseModel):
...
class SlackArchiveTool(BaseTool):
    name = "slack_archive"
    description = "Tool for slack archive operation - archive operation"
    ...
    def _run(self, **kwargs):
        """Run the slack archive operation."""
        ...
        if credentials:
            ...
            return f"Running slack archive operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack archive operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack archive operation asynchronously."""
