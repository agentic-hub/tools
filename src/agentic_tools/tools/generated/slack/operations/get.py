...
class SlackGetTool(BaseTool):
    name = "slack_get"
    description = "Tool for slack get operation - get operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running slack get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack get operation asynchronously."""
