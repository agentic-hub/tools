...
class SlackRenameToolInput(BaseModel):
    ...
    channel_id: Optional[Dict[str, Any]] = Field(None, description="The Slack channel to rename")
...
class SlackRenameTool(BaseTool):
    name = "slack_rename"
    description = "Tool for slack rename operation - rename operation"
    ...
    def _run(self, **kwargs):
        """Run the slack rename operation."""
        ...
        if credentials:
            ...
            return f"Running slack rename operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack rename operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack rename operation asynchronously."""
