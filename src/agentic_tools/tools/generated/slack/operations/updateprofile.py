...
class SlackUpdateprofileTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running slack updateProfile operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack updateProfile operation with default credentials and args: {kwargs}"
