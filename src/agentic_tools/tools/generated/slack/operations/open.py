...
class SlackOpenToolInput(BaseModel):
...
class SlackOpenTool(BaseTool):
    name = "slack_open"
    description = "Tool for slack open operation - open operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running slack open operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack open operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack open operation asynchronously."""
