...
class SlackDisableTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running slack disable operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack disable operation with default credentials and args: {kwargs}"
