...
class SlackCloseTool(BaseTool):
    name = "slack_close"
    description = "Tool for slack close operation - close operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running slack close operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack close operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack close operation asynchronously."""
