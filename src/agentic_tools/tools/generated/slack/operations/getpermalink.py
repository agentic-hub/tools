...
class SlackGetpermalinkToolInput(BaseModel):
    ...
    channelId: Optional[Dict[str, Any]] = Field(None, description="The Slack channel to get the message permalink from")
...
class SlackGetpermalinkTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running slack getPermalink operation with args: {kwargs}"
