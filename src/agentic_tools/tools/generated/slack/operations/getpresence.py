...
class SlackGetpresenceToolInput(BaseModel):
    ...
    user: Optional[Dict[str, Any]] = Field(None, description="The ID of the user to get the online status of")


class SlackGetpresenceTool(BaseTool):
    name = "slack_getpresence"
    description = "Tool for slack getPresence operation - getPresence operation"
    ...
    def _run(self, **kwargs):
        """Run the slack getPresence operation."""
        ...
        if credentials:
            ...
            return f"Running slack getPresence operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack getPresence operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack getPresence operation asynchronously."""
