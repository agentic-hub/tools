...
class SlackEnableTool(BaseTool):
    name = "slack_enable"
    description = "Tool for slack enable operation - enable operation"
    ...
    def _run(self, **kwargs):
        """Run the slack enable operation."""
        ...
        if credentials:
            ...
            return f"Running slack enable operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack enable operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack enable operation asynchronously."""
