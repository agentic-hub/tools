...
class SlackInviteToolInput(BaseModel):
    ...
    channel_id: Optional[Dict[str, Any]] = Field(None, description="The Slack channel to invite to")
...
class SlackInviteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running slack invite operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack invite operation with default credentials and args: {kwargs}"
