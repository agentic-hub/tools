...
class SlackGetprofileToolInput(BaseModel):
    ...
    user: Optional[Dict[str, Any]] = Field(None, description="The ID of the user to get information about")


class SlackGetprofileTool(BaseTool):
    name = "slack_getprofile"
    description = "Tool for slack getProfile operation - getProfile operation"
    ...
    def _run(self, **kwargs):
        """Run the slack getProfile operation."""
        ...
        if credentials:
            ...
            return f"Running slack getProfile operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack getProfile operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack getProfile operation asynchronously."""
