...
class SlackGetallToolInput(BaseModel):
...
class SlackGetallTool(BaseTool):
    name = "slack_getall"
    description = "Tool for slack getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the slack getAll operation."""
        ...
        if credentials:
            ...
            return f"Running slack getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack getAll operation asynchronously."""
