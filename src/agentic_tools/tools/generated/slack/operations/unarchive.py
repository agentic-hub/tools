...
class SlackUnarchiveToolInput(BaseModel):
    ...
    channel_id: Optional[Dict[str, Any]] = Field(None, description="The Slack channel to unarchive")
...
class SlackUnarchiveTool(BaseTool):
    ...
    description = "Tool for slack unarchive operation - unarchive operation"
    ...
    def _run(self, **kwargs):
        """Run the slack unarchive operation."""
        ...
        if credentials:
            ...
            return f"Running slack unarchive operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack unarchive operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack unarchive operation asynchronously."""
