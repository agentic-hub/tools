...
class SlackRepliesToolInput(BaseModel):
    ...
    channel_id: Optional[Dict[str, Any]] = Field(None, description="The Slack channel to replies to")
...
class SlackRepliesTool(BaseTool):
    name = "slack_replies"
    description = "Tool for slack replies operation - replies operation"
    ...
    def _run(self, **kwargs):
        """Run the slack replies operation."""
        ...
        if credentials:
            ...
            return f"Running slack replies operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running slack replies operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the slack replies operation asynchronously."""
