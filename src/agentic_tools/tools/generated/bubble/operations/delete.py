...
class BubbleDeleteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running bubble delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running bubble delete operation with default credentials and args: {kwargs}"
