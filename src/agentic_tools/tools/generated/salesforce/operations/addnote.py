...
class SalesforceAddnoteToolInput(BaseModel):
...
class SalesforceAddnoteTool(BaseTool):
    name = "salesforce_addnote"
    description = "Tool for salesforce addNote operation - addNote operation"
    ...
    def _run(self, **kwargs):
        """Run the salesforce addNote operation."""
        ...
        if credentials:
            ...
            return f"Running salesforce addNote operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesforce addNote operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesforce addNote operation asynchronously."""
