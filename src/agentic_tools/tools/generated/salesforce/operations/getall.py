...
class SalesforceGetallToolInput(BaseModel):
...
class SalesforceGetallTool(BaseTool):
    name = "salesforce_getall"
    description = "Tool for salesforce getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the salesforce getAll operation."""
        ...
        if credentials:
            ...
            return f"Running salesforce getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesforce getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesforce getAll operation asynchronously."""
