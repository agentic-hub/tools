...
class SalesforceUploadTool(BaseTool):
    ...
    description = "Tool for salesforce upload operation - upload operation"
    ...
    def _run(self, **kwargs):
        """Run the salesforce upload operation."""
        ...
        if credentials:
            ...
            return f"Running salesforce upload operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesforce upload operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesforce upload operation asynchronously."""
