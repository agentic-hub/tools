...
class SalesforceUpdateToolInput(BaseModel):
...
class SalesforceUpdateTool(BaseTool):
    ...
    description = "Tool for salesforce update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the salesforce update operation."""
        ...
        if credentials:
            ...
            return f"Running salesforce update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesforce update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesforce update operation asynchronously."""
