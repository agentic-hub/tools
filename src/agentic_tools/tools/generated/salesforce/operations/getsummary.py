...
class SalesforceGetsummaryToolInput(BaseModel):
...
class SalesforceGetsummaryTool(BaseTool):
    name = "salesforce_getsummary"
    description = "Tool for salesforce getSummary operation - getSummary operation"
    ...
    def _run(self, **kwargs):
        """Run the salesforce getSummary operation."""
        ...
        if credentials:
            ...
            return f"Running salesforce getSummary operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesforce getSummary operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesforce getSummary operation asynchronously."""
