...
class SalesforceGetToolInput(BaseModel):
    ...
    userId: Optional[str] = Field(None, description="ID of user that needs to be fetched")
    ...
    recordId: Optional[str] = Field(None, description="Record ID to be retrieved")
...
class SalesforceGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running salesforce get operation with args: {kwargs}"
