...
class SalesforceAddcommentToolInput(BaseModel):
...
class SalesforceAddcommentTool(BaseTool):
    name = "salesforce_addcomment"
    description = "Tool for salesforce addComment operation - addComment operation"
    ...
    def _run(self, **kwargs):
        """Run the salesforce addComment operation."""
        ...
        if credentials:
            ...
            return f"Running salesforce addComment operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesforce addComment operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesforce addComment operation asynchronously."""
