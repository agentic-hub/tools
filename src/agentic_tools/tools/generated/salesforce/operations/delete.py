...
class SalesforceDeleteToolInput(BaseModel):
    ...
    record_id: Optional[str] = Field(None, description="Record ID to be deleted")


class SalesforceDeleteTool(BaseTool):
    name = "salesforce_delete"
    description = "Tool for salesforce delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the salesforce delete operation."""
        ...
        if credentials:
            ...
            return f"Running salesforce delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesforce delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesforce delete operation asynchronously."""
