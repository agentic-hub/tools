...
class SalesforceInvokeToolInput(BaseModel):
    ...
    json_parameters: Optional[bool] = Field(None, description="Whether the input variables should be set via the value-key pair UI or JSON/RAW")
    ...
    variables_json: Optional[str] = Field(None, description="Input variables as JSON object")
    options: Optional[Dict[str, Any]] = Field(None, description="Options")
    api_name: Optional[str] = Field(None, description="Required. API name of the flow.")
    ...
    variables_ui: Optional[Dict[str, Any]] = Field(None, description="The input variable to send")
...
class SalesforceInvokeTool(BaseTool):
    name = "salesforce_invoke"
    description = "Tool for salesforce invoke operation - invoke operation"
    ...
    def _run(self, **kwargs):
        """Run the salesforce invoke operation."""
        ...
        if credentials:
            ...
            return f"Running salesforce invoke operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesforce invoke operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesforce invoke operation asynchronously."""
