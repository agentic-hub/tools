...
class SalesforceInvokeToolInput(BaseModel):
    ...
    jsonParameters: Optional[bool] = Field(None, description="Whether the input variables should be set via the value-key pair UI or JSON/RAW")
    ...
    variablesJson: Optional[str] = Field(None, description="Input variables as JSON object")
    options: Optional[Dict[str, Any]] = Field(None, description="Options")
    apiName: Optional[str] = Field(None, description="Required. API name of the flow.")
    ...
    variablesUi: Optional[Dict[str, Any]] = Field(None, description="The input variable to send")
...
class SalesforceInvokeTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running salesforce invoke operation with args: {kwargs}"
