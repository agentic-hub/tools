...
class SalesforceAddtocampaignToolInput(BaseModel):
    ...
    lead_id: Optional[str] = Field(None, description="ID of contact that needs to be fetched")
...
class SalesforceAddtocampaignTool(BaseTool):
    name = "salesforce_addtocampaign"
    description = "Tool for salesforce addToCampaign operation - addToCampaign operation"
    ...
    def _run(self, **kwargs):
        """Run the salesforce addToCampaign operation."""
        ...
        if credentials:
            ...
            return f"Running salesforce addToCampaign operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesforce addToCampaign operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesforce addToCampaign operation asynchronously."""
