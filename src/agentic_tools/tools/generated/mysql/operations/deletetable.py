...
class MysqlDeletetableTool(BaseTool):
    name = "mysql_deletetable"
    description = "Tool for mySql deleteTable operation - deleteTable operation"
    ...
    def _run(self, **kwargs):
        """Run the mySql deleteTable operation."""
        ...
        if credentials:
            ...
            return f"Running mySql deleteTable operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mySql deleteTable operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the mySql deleteTable operation asynchronously."""
