...
class HelpscoutPropertiesToolInput(BaseModel):
...
class HelpscoutPropertiesTool(BaseTool):
    name = "helpscout_properties"
    description = "Tool for helpScout properties operation - properties operation"
    ...
    def _run(self, **kwargs):
        """Run the helpScout properties operation."""
        ...
        if credentials:
            ...
            return f"Running helpScout properties operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running helpScout properties operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the helpScout properties operation asynchronously."""
