...
class ZulipGetsubscribedToolInput(BaseModel):
...
class ZulipGetsubscribedTool(BaseTool):
    name = "zulip_getsubscribed"
    description = "Tool for zulip getSubscribed operation - getSubscribed operation"
    ...
    def _run(self, **kwargs):
        """Run the zulip getSubscribed operation."""
        ...
        if credentials:
            ...
            return f"Running zulip getSubscribed operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zulip getSubscribed operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the zulip getSubscribed operation asynchronously."""
