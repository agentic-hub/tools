...
class ZulipSendprivateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running zulip sendPrivate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zulip sendPrivate operation with default credentials and args: {kwargs}"
