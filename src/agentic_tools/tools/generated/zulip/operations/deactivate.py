...
class ZulipDeactivateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running zulip deactivate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zulip deactivate operation with default credentials and args: {kwargs}"
