...
class MicrosoftteamsGetallTool(BaseTool):
    name = "microsoftteams_getall"
    description = "Tool for microsoftTeams getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftTeams getAll operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftTeams getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftTeams getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftTeams getAll operation asynchronously."""
