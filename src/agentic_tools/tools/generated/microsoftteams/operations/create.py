...
class MicrosoftteamsCreateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running microsoftTeams create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftTeams create operation with default credentials and args: {kwargs}"
