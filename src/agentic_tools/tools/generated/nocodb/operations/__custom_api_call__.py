...
class Nocodb__custom_api_call__Tool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running nocoDb __CUSTOM_API_CALL__ operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running nocoDb __CUSTOM_API_CALL__ operation with default credentials and args: {kwargs}"
