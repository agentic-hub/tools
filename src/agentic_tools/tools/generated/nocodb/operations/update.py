...
class NocodbUpdateToolInput(BaseModel):
...
class NocodbUpdateTool(BaseTool):
    name = "nocodb_update"
    description = "Tool for nocoDb update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the nocoDb update operation."""
        ...
        if credentials:
            ...
            return f"Running nocoDb update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running nocoDb update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the nocoDb update operation asynchronously."""
