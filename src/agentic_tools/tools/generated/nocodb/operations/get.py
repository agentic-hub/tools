...
class NocodbGetTool(BaseTool):
    name = "nocodb_get"
    description = "Tool for nocoDb get operation - get operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running nocoDb get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running nocoDb get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the nocoDb get operation asynchronously."""
