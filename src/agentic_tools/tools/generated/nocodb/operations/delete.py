...
class NocodbDeleteTool(BaseTool):
    name = "nocodb_delete"
    description = "Tool for nocoDb delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the nocoDb delete operation."""
        ...
        if credentials:
            ...
            return f"Running nocoDb delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running nocoDb delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the nocoDb delete operation asynchronously."""
