...
class BamboohrDownloadToolInput(BaseModel):
...
class BamboohrDownloadTool(BaseTool):
    name = "bamboohr_download"
    description = "Tool for bambooHr download operation - download operation"
    ...
    def _run(self, **kwargs):
        """Run the bambooHr download operation."""
        ...
        if credentials:
            ...
            return f"Running bambooHr download operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running bambooHr download operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the bambooHr download operation asynchronously."""
