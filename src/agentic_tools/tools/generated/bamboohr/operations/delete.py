...
class BamboohrDeleteToolInput(BaseModel):
...
class BamboohrDeleteTool(BaseTool):
    name = "bamboohr_delete"
    description = "Tool for bambooHr delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the bambooHr delete operation."""
        ...
        if credentials:
            ...
            return f"Running bambooHr delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running bambooHr delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the bambooHr delete operation asynchronously."""
