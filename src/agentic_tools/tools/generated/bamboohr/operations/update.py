...
class BamboohrUpdateToolInput(BaseModel):
    ...
    addasasress: Optional[Dict[str, Any]] = Field(None, description="Address")
    preferred_name: Optional[str] = Field(None, description="Preferred Name")


class BamboohrUpdateTool(BaseTool):
    name = "bamboohr_update"
    description = "Tool for bambooHr update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the bambooHr update operation."""
        ...
        if credentials:
            ...
            return f"Running bambooHr update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running bambooHr update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the bambooHr update operation asynchronously."""
