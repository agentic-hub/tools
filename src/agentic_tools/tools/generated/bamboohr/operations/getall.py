...
class BamboohrGetallTool(BaseTool):
    name = "bamboohr_getall"
    description = "Tool for bambooHr getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the bambooHr getAll operation."""
        ...
        if credentials:
            ...
            return f"Running bambooHr getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running bambooHr getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the bambooHr getAll operation asynchronously."""
