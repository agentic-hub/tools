...
class AsanaAddTool(BaseTool):
    name = "asana_add"
    description = "Tool for asana add operation - add operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running asana add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running asana add operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the asana add operation asynchronously."""
