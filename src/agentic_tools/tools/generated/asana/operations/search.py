...
class AsanaSearchTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running asana search operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running asana search operation with default credentials and args: {kwargs}"
