...
class AsanaRemoveTool(BaseTool):
    name = "asana_remove"
    description = "Tool for asana remove operation - remove operation"
    ...
    def _run(self, **kwargs):
        """Run the asana remove operation."""
        ...
        if credentials:
            ...
            return f"Running asana remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running asana remove operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the asana remove operation asynchronously."""
