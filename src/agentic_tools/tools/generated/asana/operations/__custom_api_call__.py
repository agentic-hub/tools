...
class Asana__custom_api_call__Tool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running asana __CUSTOM_API_CALL__ operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running asana __CUSTOM_API_CALL__ operation with default credentials and args: {kwargs}"
