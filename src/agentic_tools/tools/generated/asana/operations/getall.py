...
class AsanaGetallTool(BaseTool):
    name = "asana_getall"
    description = "Tool for asana getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the asana getAll operation."""
        ...
        if credentials:
            ...
            return f"Running asana getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running asana getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the asana getAll operation asynchronously."""
