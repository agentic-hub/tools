...
class MicrosoftexcelAddtableToolInput(BaseModel):
    ...
    has_headers: Optional[bool] = Field(None, description="Whether the range has column labels. When this property set to false Excel will automatically generate header shifting the data down by one row.")
    ...
    select_range: Optional[str] = Field(None, description="Select Range")
