...
class MicrosoftexcelGetcolumnsTool(BaseTool):
    name = "microsoftexcel_getcolumns"
    description = "Tool for microsoftExcel getColumns operation - getColumns operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftExcel getColumns operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftExcel getColumns operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftExcel getColumns operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftExcel getColumns operation asynchronously."""
