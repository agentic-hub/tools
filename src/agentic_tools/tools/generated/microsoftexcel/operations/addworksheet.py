...
class MicrosoftexcelAddworksheetToolInput(BaseModel):
...
class MicrosoftexcelAddworksheetTool(BaseTool):
    name = "microsoftexcel_addworksheet"
    description = "Tool for microsoftExcel addWorksheet operation - addWorksheet operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftExcel addWorksheet operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftExcel addWorksheet operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftExcel addWorksheet operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftExcel addWorksheet operation asynchronously."""
