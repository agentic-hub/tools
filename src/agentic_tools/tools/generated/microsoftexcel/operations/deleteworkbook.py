...
class MicrosoftexcelDeleteworkbookToolInput(BaseModel):
...
class MicrosoftexcelDeleteworkbookTool(BaseTool):
    name = "microsoftexcel_deleteworkbook"
    description = "Tool for microsoftExcel deleteWorkbook operation - deleteWorkbook operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftExcel deleteWorkbook operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftExcel deleteWorkbook operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftExcel deleteWorkbook operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftExcel deleteWorkbook operation asynchronously."""
