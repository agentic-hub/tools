...
class MicrosoftexcelAppendTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running microsoftExcel append operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftExcel append operation with default credentials and args: {kwargs}"
