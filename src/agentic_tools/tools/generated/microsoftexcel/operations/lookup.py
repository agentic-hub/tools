...
class MicrosoftexcelLookupToolInput(BaseModel):
    ...
    lookupValue: Optional[str] = Field(None, description="The value to look for in column")
    returnAll: Optional[bool] = Field(None, description="Whether to return all results or only up to a given limit")
    lookupColumn: Optional[str] = Field(None, description="The name of the column in which to look for value")
...
class MicrosoftexcelLookupTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running microsoftExcel lookup operation with args: {kwargs}"
