...
class MicrosoftexcelLookupToolInput(BaseModel):
    ...
    lookup_value: Optional[str] = Field(None, description="The value to look for in column")
    return_all: Optional[bool] = Field(None, description="Whether to return all results or only up to a given limit")
    lookup_column: Optional[str] = Field(None, description="The name of the column in which to look for value")
...
class MicrosoftexcelLookupTool(BaseTool):
    name = "microsoftexcel_lookup"
    description = "Tool for microsoftExcel lookup operation - lookup operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftExcel lookup operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftExcel lookup operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftExcel lookup operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftExcel lookup operation asynchronously."""
