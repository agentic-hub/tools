...
class MicrosoftexcelClearTool(BaseTool):
    name = "microsoftexcel_clear"
    description = "Tool for microsoftExcel clear operation - clear operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftExcel clear operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftExcel clear operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftExcel clear operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftExcel clear operation asynchronously."""
