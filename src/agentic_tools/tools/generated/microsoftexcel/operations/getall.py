...
class MicrosoftexcelGetallToolInput(BaseModel):
...
class MicrosoftexcelGetallTool(BaseTool):
    name = "microsoftexcel_getall"
    description = "Tool for microsoftExcel getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftExcel getAll operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftExcel getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftExcel getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftExcel getAll operation asynchronously."""
