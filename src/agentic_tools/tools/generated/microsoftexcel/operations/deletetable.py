...
class MicrosoftexcelDeletetableToolInput(BaseModel):
...
class MicrosoftexcelDeletetableTool(BaseTool):
    name = "microsoftexcel_deletetable"
    description = "Tool for microsoftExcel deleteTable operation - deleteTable operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftExcel deleteTable operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftExcel deleteTable operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftExcel deleteTable operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftExcel deleteTable operation asynchronously."""
