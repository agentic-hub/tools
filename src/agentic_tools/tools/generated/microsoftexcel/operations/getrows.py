...
class MicrosoftexcelGetrowsToolInput(BaseModel):
...
class MicrosoftexcelGetrowsTool(BaseTool):
    name = "microsoftexcel_getrows"
    description = "Tool for microsoftExcel getRows operation - getRows operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftExcel getRows operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftExcel getRows operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftExcel getRows operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftExcel getRows operation asynchronously."""
