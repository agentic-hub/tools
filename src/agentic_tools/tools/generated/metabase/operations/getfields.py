...
class MetabaseGetfieldsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running metabase getFields operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running metabase getFields operation with default credentials and args: {kwargs}"
