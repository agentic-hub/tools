...
class BrandfetchIndustryTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running Brandfetch industry operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running Brandfetch industry operation with default credentials and args: {kwargs}"
