...
class ElasticsearchUpdateToolInput(BaseModel):
    ...
    indexId: Optional[str] = Field(None, description="ID of the document to update")
    ...
    documentId: Optional[str] = Field(None, description="ID of the document to update")
...
class ElasticsearchUpdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running elasticsearch update operation with args: {kwargs}"
