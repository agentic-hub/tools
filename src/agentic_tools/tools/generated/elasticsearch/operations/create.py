...
class ElasticsearchCreateTool(BaseTool):
    ...
    description = "Tool for elasticsearch create operation - create operation"
    ...
    def _run(self, **kwargs):
        """Run the elasticsearch create operation."""
        ...
        if credentials:
            ...
            return f"Running elasticsearch create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running elasticsearch create operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the elasticsearch create operation asynchronously."""
