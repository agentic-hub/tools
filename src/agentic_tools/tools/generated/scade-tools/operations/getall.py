...
class Scade-toolsGetallTool(BaseTool):
    name: str = "scade-tools_getall"
    description: str = "Tool for scade-tools getAll operation - getAll operation"
    args_schema: type[BaseModel] | None = Scade-toolsGetallToolInput
