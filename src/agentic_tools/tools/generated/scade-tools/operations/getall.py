...
class Scade-toolsGetallToolInput(BaseModel):
...
class Scade-toolsGetallTool(BaseTool):
    name = "scade-tools_getall"
    description = "Tool for scade-tools getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the scade-tools getAll operation."""
        ...
        if credentials:
            ...
            return f"Running scade-tools getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running scade-tools getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the scade-tools getAll operation asynchronously."""
