...
class Scade-toolsGetschemaTool(BaseTool):
    name = "scade-tools_getschema"
    description = "Tool for scade-tools getSchema operation - getSchema operation"
    ...
    def _run(self, **kwargs):
        """Run the scade-tools getSchema operation."""
        ...
        if credentials:
            ...
            return f"Running scade-tools getSchema operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running scade-tools getSchema operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the scade-tools getSchema operation asynchronously."""
