...
class Scade-toolsGenerateToolInput(BaseModel):
...
class Scade-toolsGenerateTool(BaseTool):
    name = "scade-tools_generate"
    description = "Tool for scade-tools generate operation - generate operation"
    ...
    def _run(self, **kwargs):
        """Run the scade-tools generate operation."""
        ...
        if credentials:
            ...
            return f"Running scade-tools generate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running scade-tools generate operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the scade-tools generate operation asynchronously."""
