...
class Scade-toolsDeactivateToolInput(BaseModel):
...
class Scade-toolsDeactivateTool(BaseTool):
    name = "scade-tools_deactivate"
    description = "Tool for scade-tools deactivate operation - deactivate operation"
    ...
    def _run(self, **kwargs):
        """Run the scade-tools deactivate operation."""
        ...
        if credentials:
            ...
            return f"Running scade-tools deactivate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running scade-tools deactivate operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the scade-tools deactivate operation asynchronously."""
