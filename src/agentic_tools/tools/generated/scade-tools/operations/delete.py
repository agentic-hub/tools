...
class Scade-toolsDeleteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running scade-tools delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running scade-tools delete operation with default credentials and args: {kwargs}"
