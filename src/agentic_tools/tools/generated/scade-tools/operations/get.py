...
class Scade-toolsGetToolInput(BaseModel):
...
class Scade-toolsGetTool(BaseTool):
    name = "scade-tools_get"
    description = "Tool for scade-tools get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the scade-tools get operation."""
        ...
        if credentials:
            ...
            return f"Running scade-tools get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running scade-tools get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the scade-tools get operation asynchronously."""
