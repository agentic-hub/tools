...
class CloudflareGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running cloudflare get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running cloudflare get operation with default credentials and args: {kwargs}"
