...
class StripeAddTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running stripe add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running stripe add operation with default credentials and args: {kwargs}"
