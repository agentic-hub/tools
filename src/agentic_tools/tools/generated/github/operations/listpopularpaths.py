...
class GithubListpopularpathsToolInput(BaseModel):
...
class GithubListpopularpathsTool(BaseTool):
    name = "github_listpopularpaths"
    description = "Tool for github listPopularPaths operation - listPopularPaths operation"
    ...
    def _run(self, **kwargs):
        """Run the github listPopularPaths operation."""
        ...
        if credentials:
            ...
            return f"Running github listPopularPaths operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running github listPopularPaths operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the github listPopularPaths operation asynchronously."""
