...
class GithubListreferrersToolInput(BaseModel):
...
class GithubListreferrersTool(BaseTool):
    name = "github_listreferrers"
    description = "Tool for github listReferrers operation - listReferrers operation"
    ...
    def _run(self, **kwargs):
        """Run the github listReferrers operation."""
        ...
        if credentials:
            ...
            return f"Running github listReferrers operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running github listReferrers operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the github listReferrers operation asynchronously."""
