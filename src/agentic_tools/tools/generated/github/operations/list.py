...
class GithubListTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running github list operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running github list operation with default credentials and args: {kwargs}"
