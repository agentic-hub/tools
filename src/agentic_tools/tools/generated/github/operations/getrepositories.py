...
class GithubGetrepositoriesTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running github getRepositories operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running github getRepositories operation with default credentials and args: {kwargs}"
