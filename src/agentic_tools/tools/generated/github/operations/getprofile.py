...
class GithubGetprofileToolInput(BaseModel):
...
class GithubGetprofileTool(BaseTool):
    name = "github_getprofile"
    description = "Tool for github getProfile operation - getProfile operation"
    ...
    def _run(self, **kwargs):
        """Run the github getProfile operation."""
        ...
        if credentials:
            ...
            return f"Running github getProfile operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running github getProfile operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the github getProfile operation asynchronously."""
