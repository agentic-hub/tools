...
class ThehiveprojectDeletecaseToolInput(BaseModel):
...
class ThehiveprojectDeletecaseTool(BaseTool):
    name = "thehiveproject_deletecase"
    description = "Tool for theHiveProject deleteCase operation - deleteCase operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject deleteCase operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject deleteCase operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject deleteCase operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject deleteCase operation asynchronously."""
