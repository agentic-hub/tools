...
class ThehiveprojectExecuteresponderToolInput(BaseModel):
...
class ThehiveprojectExecuteresponderTool(BaseTool):
    name = "thehiveproject_executeresponder"
    description = "Tool for theHiveProject executeResponder operation - executeResponder operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject executeResponder operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject executeResponder operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject executeResponder operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject executeResponder operation asynchronously."""
