...
class ThehiveprojectDeletelogToolInput(BaseModel):
...
class ThehiveprojectDeletelogTool(BaseTool):
    name = "thehiveproject_deletelog"
    description = "Tool for theHiveProject deleteLog operation - deleteLog operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject deleteLog operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject deleteLog operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject deleteLog operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject deleteLog operation asynchronously."""
