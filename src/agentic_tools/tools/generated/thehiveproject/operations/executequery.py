...
class ThehiveprojectExecutequeryToolInput(BaseModel):
    ...
    query_json: Optional[str] = Field(None, description="Search for objects with filtering and sorting capabilities")
...
class ThehiveprojectExecutequeryTool(BaseTool):
    name = "thehiveproject_executequery"
    description = "Tool for theHiveProject executeQuery operation - executeQuery operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject executeQuery operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject executeQuery operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject executeQuery operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject executeQuery operation asynchronously."""
