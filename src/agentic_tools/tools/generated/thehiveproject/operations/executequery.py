...
class ThehiveprojectExecutequeryToolInput(BaseModel):
    ...
    queryJson: Optional[str] = Field(None, description="Search for objects with filtering and sorting capabilities")
...
class ThehiveprojectExecutequeryTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running theHiveProject executeQuery operation with args: {kwargs}"
