...
class ThehiveprojectDeletecommentToolInput(BaseModel):
...
class ThehiveprojectDeletecommentTool(BaseTool):
    name = "thehiveproject_deletecomment"
    description = "Tool for theHiveProject deleteComment operation - deleteComment operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject deleteComment operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject deleteComment operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject deleteComment operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject deleteComment operation asynchronously."""
