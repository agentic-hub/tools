...
class ThehiveprojectDeletetaskToolInput(BaseModel):
...
class ThehiveprojectDeletetaskTool(BaseTool):
    name = "thehiveproject_deletetask"
    description = "Tool for theHiveProject deleteTask operation - deleteTask operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject deleteTask operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject deleteTask operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject deleteTask operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject deleteTask operation asynchronously."""
