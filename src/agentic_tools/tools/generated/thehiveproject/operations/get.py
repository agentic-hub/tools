...
class ThehiveprojectGetToolInput(BaseModel):
...
class ThehiveprojectGetTool(BaseTool):
    name = "thehiveproject_get"
    description = "Tool for theHiveProject get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject get operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject get operation asynchronously."""
