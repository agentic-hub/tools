...
class ThehiveprojectDeletealertTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running theHiveProject deleteAlert operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject deleteAlert operation with default credentials and args: {kwargs}"
