...
class ThehiveprojectAddToolInput(BaseModel):
    ...
    add_to: Optional[str] = Field(None, description="Add to")
...
class ThehiveprojectAddTool(BaseTool):
    name = "thehiveproject_add"
    description = "Tool for theHiveProject add operation - add operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject add operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject add operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject add operation asynchronously."""
