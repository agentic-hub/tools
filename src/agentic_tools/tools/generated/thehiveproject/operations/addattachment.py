...
class ThehiveprojectAddattachmentToolInput(BaseModel):
...
class ThehiveprojectAddattachmentTool(BaseTool):
    name = "thehiveproject_addattachment"
    description = "Tool for theHiveProject addAttachment operation - addAttachment operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject addAttachment operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject addAttachment operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject addAttachment operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject addAttachment operation asynchronously."""
