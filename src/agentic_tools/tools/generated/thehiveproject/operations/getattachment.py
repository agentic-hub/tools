...
class ThehiveprojectGetattachmentToolInput(BaseModel):
...
class ThehiveprojectGetattachmentTool(BaseTool):
    name = "thehiveproject_getattachment"
    description = "Tool for theHiveProject getAttachment operation - getAttachment operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject getAttachment operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject getAttachment operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject getAttachment operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject getAttachment operation asynchronously."""
