...
class ThehiveprojectMergeToolInput(BaseModel):
...
class ThehiveprojectMergeTool(BaseTool):
    name = "thehiveproject_merge"
    description = "Tool for theHiveProject merge operation - merge operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject merge operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject merge operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject merge operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject merge operation asynchronously."""
