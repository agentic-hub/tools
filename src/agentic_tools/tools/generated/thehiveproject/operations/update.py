...
class ThehiveprojectUpdateToolInput(BaseModel):
    ...
    location: Optional[str] = Field(None, description="Update in")
...
class ThehiveprojectUpdateTool(BaseTool):
    name = "thehiveproject_update"
    description = "Tool for theHiveProject update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject update operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject update operation asynchronously."""
