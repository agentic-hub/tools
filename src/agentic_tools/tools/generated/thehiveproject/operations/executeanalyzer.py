...
class ThehiveprojectExecuteanalyzerToolInput(BaseModel):
    ...
    dataType: Optional[str] = Field(None, description="Type of the observable. Choose from the list, or specify an ID using an <a href=\"https://docs.n8n.io/code-examples/expressions/\">expression</a>.")
...
class ThehiveprojectExecuteanalyzerTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running theHiveProject executeAnalyzer operation with args: {kwargs}"
