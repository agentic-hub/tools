...
class ThehiveprojectDeletepageToolInput(BaseModel):
    ...
    location: Optional[str] = Field(None, description="Delete From ...")
...
class ThehiveprojectDeletepageTool(BaseTool):
    name = "thehiveproject_deletepage"
    description = "Tool for theHiveProject deletePage operation - deletePage operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject deletePage operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject deletePage operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject deletePage operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject deletePage operation asynchronously."""
