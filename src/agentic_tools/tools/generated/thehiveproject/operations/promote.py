...
class ThehiveprojectPromoteToolInput(BaseModel):
...
class ThehiveprojectPromoteTool(BaseTool):
    name = "thehiveproject_promote"
    description = "Tool for theHiveProject promote operation - promote operation"
    ...
    def _run(self, **kwargs):
        """Run the theHiveProject promote operation."""
        ...
        if credentials:
            ...
            return f"Running theHiveProject promote operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running theHiveProject promote operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the theHiveProject promote operation asynchronously."""
