...
class NetlifyCancelTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running netlify cancel operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running netlify cancel operation with default credentials and args: {kwargs}"
