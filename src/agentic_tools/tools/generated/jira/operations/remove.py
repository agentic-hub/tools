...
class JiraRemoveTool(BaseTool):
    name = "jira_remove"
    description = "Tool for jira remove operation - remove operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running jira remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jira remove operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the jira remove operation asynchronously."""
