...
class JiraGetallToolInput(BaseModel):
...
class JiraGetallTool(BaseTool):
    name = "jira_getall"
    description = "Tool for jira getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running jira getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jira getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the jira getAll operation asynchronously."""
