...
class JiraTransitionsTool(BaseTool):
    ...
    description = "Tool for jira transitions operation - transitions operation"
    ...
    def _run(self, **kwargs):
        """Run the jira transitions operation."""
        ...
        if credentials:
            ...
            return f"Running jira transitions operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jira transitions operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the jira transitions operation asynchronously."""
