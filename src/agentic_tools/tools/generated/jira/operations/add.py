...
class JiraAddTool(BaseTool):
    name = "jira_add"
    description = "Tool for jira add operation - add operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running jira add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jira add operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the jira add operation asynchronously."""
