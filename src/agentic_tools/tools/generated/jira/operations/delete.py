...
class JiraDeleteToolInput(BaseModel):
    ...
    delete_subtasks: Optional[bool] = Field(None, description="Delete Subtasks")
...
class JiraDeleteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running jira delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jira delete operation with default credentials and args: {kwargs}"
