...
class JiraUpdateToolInput(BaseModel):
...
class JiraUpdateTool(BaseTool):
    name = "jira_update"
    description = "Tool for jira update operation - update operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running jira update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jira update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the jira update operation asynchronously."""
