...
class BitwardenDeleteTool(BaseTool):
    ...
    description = "Tool for bitwarden delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the bitwarden delete operation."""
        ...
        if credentials:
            ...
            return f"Running bitwarden delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running bitwarden delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the bitwarden delete operation asynchronously."""
