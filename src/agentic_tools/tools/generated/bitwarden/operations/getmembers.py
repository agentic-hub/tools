...
class BitwardenGetmembersTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running bitwarden getMembers operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running bitwarden getMembers operation with default credentials and args: {kwargs}"
