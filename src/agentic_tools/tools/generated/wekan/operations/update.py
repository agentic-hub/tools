...
class WekanUpdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running wekan update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running wekan update operation with default credentials and args: {kwargs}"
