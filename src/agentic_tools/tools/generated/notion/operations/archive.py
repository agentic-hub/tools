...
class NotionArchiveToolInput(BaseModel):
    ...
    page_id: Optional[Dict[str, Any]] = Field(None, description="The Notion Page to archive")
...
class NotionArchiveTool(BaseTool):
    name = "notion_archive"
    description = "Tool for notion archive operation - archive operation"
    ...
    def _run(self, **kwargs):
        """Run the notion archive operation."""
        ...
        if credentials:
            ...
            return f"Running notion archive operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running notion archive operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the notion archive operation asynchronously."""
