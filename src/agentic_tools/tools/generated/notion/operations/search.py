...
class NotionSearchTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running notion search operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running notion search operation with default credentials and args: {kwargs}"
