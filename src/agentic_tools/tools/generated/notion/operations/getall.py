...
class NotionGetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running notion getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running notion getAll operation with default credentials and args: {kwargs}"
