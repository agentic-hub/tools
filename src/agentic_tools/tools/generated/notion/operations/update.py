...
class NotionUpdateToolInput(BaseModel):
...
class NotionUpdateTool(BaseTool):
    name = "notion_update"
    description = "Tool for notion update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the notion update operation."""
        ...
        if credentials:
            ...
            return f"Running notion update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running notion update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the notion update operation asynchronously."""
