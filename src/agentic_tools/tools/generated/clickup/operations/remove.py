...
class ClickupRemoveToolInput(BaseModel):
...
class ClickupRemoveTool(BaseTool):
    name = "clickup_remove"
    description = "Tool for clickUp remove operation - remove operation"
    ...
    def _run(self, **kwargs):
        """Run the clickUp remove operation."""
        ...
        if credentials:
            ...
            return f"Running clickUp remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running clickUp remove operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the clickUp remove operation asynchronously."""
