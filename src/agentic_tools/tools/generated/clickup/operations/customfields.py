...
class ClickupCustomfieldsToolInput(BaseModel):
...
class ClickupCustomfieldsTool(BaseTool):
    name = "clickup_customfields"
    description = "Tool for clickUp customFields operation - customFields operation"
    ...
    def _run(self, **kwargs):
        """Run the clickUp customFields operation."""
        ...
        if credentials:
            ...
            return f"Running clickUp customFields operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running clickUp customFields operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the clickUp customFields operation asynchronously."""
