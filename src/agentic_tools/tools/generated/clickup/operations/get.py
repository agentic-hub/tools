...
class ClickupGetTool(BaseTool):
    name = "clickup_get"
    description = "Tool for clickUp get operation - get operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running clickUp get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running clickUp get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the clickUp get operation asynchronously."""
