...
class ClickupStopToolInput(BaseModel):
...
class ClickupStopTool(BaseTool):
    name = "clickup_stop"
    description = "Tool for clickUp stop operation - stop operation"
    ...
    def _run(self, **kwargs):
        """Run the clickUp stop operation."""
        ...
        if credentials:
            ...
            return f"Running clickUp stop operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running clickUp stop operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the clickUp stop operation asynchronously."""
