...
class ClickupStartToolInput(BaseModel):
...
class ClickupStartTool(BaseTool):
    name = "clickup_start"
    description = "Tool for clickUp start operation - start operation"
    ...
    def _run(self, **kwargs):
        """Run the clickUp start operation."""
        ...
        if credentials:
            ...
            return f"Running clickUp start operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running clickUp start operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the clickUp start operation asynchronously."""
