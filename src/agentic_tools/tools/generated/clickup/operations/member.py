...
class ClickupMemberToolInput(BaseModel):
...
class ClickupMemberTool(BaseTool):
    name = "clickup_member"
    description = "Tool for clickUp member operation - member operation"
    ...
    def _run(self, **kwargs):
        """Run the clickUp member operation."""
        ...
        if credentials:
            ...
            return f"Running clickUp member operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running clickUp member operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the clickUp member operation asynchronously."""
