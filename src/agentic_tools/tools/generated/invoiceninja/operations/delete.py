...
class InvoiceninjaDeleteTool(BaseTool):
    name = "invoiceninja_delete"
    description = "Tool for invoiceNinja delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the invoiceNinja delete operation."""
        ...
        if credentials:
            ...
            return f"Running invoiceNinja delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running invoiceNinja delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the invoiceNinja delete operation asynchronously."""
