...
class InvoiceninjaCreateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running invoiceNinja create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running invoiceNinja create operation with default credentials and args: {kwargs}"
