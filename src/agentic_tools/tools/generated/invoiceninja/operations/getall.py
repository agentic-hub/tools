...
class InvoiceninjaGetallToolInput(BaseModel):
...
class InvoiceninjaGetallTool(BaseTool):
    name = "invoiceninja_getall"
    description = "Tool for invoiceNinja getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the invoiceNinja getAll operation."""
        ...
        if credentials:
            ...
            return f"Running invoiceNinja getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running invoiceNinja getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the invoiceNinja getAll operation asynchronously."""
