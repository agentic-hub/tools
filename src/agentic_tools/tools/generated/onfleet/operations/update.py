...
class OnfleetUpdateToolInput(BaseModel):
...
class OnfleetUpdateTool(BaseTool):
    name = "onfleet_update"
    description = "Tool for onfleet update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the onfleet update operation."""
        ...
        if credentials:
            ...
            return f"Running onfleet update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running onfleet update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the onfleet update operation asynchronously."""
