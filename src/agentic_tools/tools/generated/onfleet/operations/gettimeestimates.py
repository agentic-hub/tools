...
class OnfleetGettimeestimatesTool(BaseTool):
    name = "onfleet_gettimeestimates"
    description = "Tool for onfleet getTimeEstimates operation - getTimeEstimates operation"
    ...
    def _run(self, **kwargs):
        """Run the onfleet getTimeEstimates operation."""
        ...
        if credentials:
            ...
            return f"Running onfleet getTimeEstimates operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running onfleet getTimeEstimates operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the onfleet getTimeEstimates operation asynchronously."""
