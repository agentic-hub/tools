...
class OnfleetAddtaskTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running onfleet addTask operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running onfleet addTask operation with default credentials and args: {kwargs}"
