...
class OnfleetAutodispatchToolInput(BaseModel):
...
class OnfleetAutodispatchTool(BaseTool):
    name = "onfleet_autodispatch"
    description = "Tool for onfleet autoDispatch operation - autoDispatch operation"
    ...
    def _run(self, **kwargs):
        """Run the onfleet autoDispatch operation."""
        ...
        if credentials:
            ...
            return f"Running onfleet autoDispatch operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running onfleet autoDispatch operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the onfleet autoDispatch operation asynchronously."""
