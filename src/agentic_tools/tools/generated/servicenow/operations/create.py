...
class ServicenowCreateTool(BaseTool):
    ...
    description = "Tool for serviceNow create operation - create operation"
    ...
    def _run(self, **kwargs):
        """Run the serviceNow create operation."""
        ...
        if credentials:
            ...
            return f"Running serviceNow create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running serviceNow create operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the serviceNow create operation asynchronously."""
