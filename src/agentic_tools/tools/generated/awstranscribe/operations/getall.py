...
class AwstranscribeGetallTool(BaseTool):
    name = "awstranscribe_getall"
    description = "Tool for awsTranscribe getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the awsTranscribe getAll operation."""
        ...
        if credentials:
            ...
            return f"Running awsTranscribe getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running awsTranscribe getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the awsTranscribe getAll operation asynchronously."""
