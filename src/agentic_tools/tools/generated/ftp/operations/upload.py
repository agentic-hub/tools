...
class FtpUploadTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running ftp upload operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running ftp upload operation with default credentials and args: {kwargs}"
