...
class PosthogScreenTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running postHog screen operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running postHog screen operation with default credentials and args: {kwargs}"
