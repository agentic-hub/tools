...
class HomeassistantCheckTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running homeAssistant check operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running homeAssistant check operation with default credentials and args: {kwargs}"
