...
class HomeassistantGeterrologsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running homeAssistant getErroLogs operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running homeAssistant getErroLogs operation with default credentials and args: {kwargs}"
