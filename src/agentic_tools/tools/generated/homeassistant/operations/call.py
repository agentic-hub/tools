...
class HomeassistantCallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running homeAssistant call operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running homeAssistant call operation with default credentials and args: {kwargs}"
