...
class KobotoolboxGetvalidationTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running koBoToolbox getValidation operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running koBoToolbox getValidation operation with default credentials and args: {kwargs}"
