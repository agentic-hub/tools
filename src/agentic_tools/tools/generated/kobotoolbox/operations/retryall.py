...
class KobotoolboxRetryallTool(BaseTool):
    name = "kobotoolbox_retryall"
    description = "Tool for koBoToolbox retryAll operation - retryAll operation"
    ...
    def _run(self, **kwargs):
        """Run the koBoToolbox retryAll operation."""
        ...
        if credentials:
            ...
            return f"Running koBoToolbox retryAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running koBoToolbox retryAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the koBoToolbox retryAll operation asynchronously."""
