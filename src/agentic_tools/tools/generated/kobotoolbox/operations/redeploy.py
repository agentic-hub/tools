...
class KobotoolboxRedeployToolInput(BaseModel):
...
class KobotoolboxRedeployTool(BaseTool):
    name = "kobotoolbox_redeploy"
    description = "Tool for koBoToolbox redeploy operation - redeploy operation"
    ...
    def _run(self, **kwargs):
        """Run the koBoToolbox redeploy operation."""
        ...
        if credentials:
            ...
            return f"Running koBoToolbox redeploy operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running koBoToolbox redeploy operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the koBoToolbox redeploy operation asynchronously."""
