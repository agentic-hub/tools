...
class KobotoolboxGetlogsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running koBoToolbox getLogs operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running koBoToolbox getLogs operation with default credentials and args: {kwargs}"
