...
class KobotoolboxSetvalidationTool(BaseTool):
    name = "kobotoolbox_setvalidation"
    description = "Tool for koBoToolbox setValidation operation - setValidation operation"
    ...
    def _run(self, **kwargs):
        """Run the koBoToolbox setValidation operation."""
        ...
        if credentials:
            ...
            return f"Running koBoToolbox setValidation operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running koBoToolbox setValidation operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the koBoToolbox setValidation operation asynchronously."""
