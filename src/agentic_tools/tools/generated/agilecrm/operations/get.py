...
class AgilecrmGetTool(BaseTool):
    name = "agilecrm_get"
    description = "Tool for agileCrm get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the agileCrm get operation."""
        ...
        if credentials:
            ...
            return f"Running agileCrm get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running agileCrm get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the agileCrm get operation asynchronously."""
