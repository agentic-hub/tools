...
class ZendeskCountTool(BaseTool):
    name = "zendesk_count"
    description = "Tool for zendesk count operation - count operation"
    ...
    def _run(self, **kwargs):
        """Run the zendesk count operation."""
        ...
        if credentials:
            ...
            return f"Running zendesk count operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zendesk count operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the zendesk count operation asynchronously."""
