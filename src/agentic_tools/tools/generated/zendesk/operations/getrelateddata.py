...
class ZendeskGetrelateddataTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running zendesk getRelatedData operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zendesk getRelatedData operation with default credentials and args: {kwargs}"
