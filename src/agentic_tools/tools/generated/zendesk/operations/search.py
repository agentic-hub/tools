...
class ZendeskSearchTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running zendesk search operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zendesk search operation with default credentials and args: {kwargs}"
