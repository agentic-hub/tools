...
class ZendeskRecoverTool(BaseTool):
    name = "zendesk_recover"
    description = "Tool for zendesk recover operation - recover operation"
    ...
    def _run(self, **kwargs):
        """Run the zendesk recover operation."""
        ...
        if credentials:
            ...
            return f"Running zendesk recover operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zendesk recover operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the zendesk recover operation asynchronously."""
