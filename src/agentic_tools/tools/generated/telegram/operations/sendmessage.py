...
class TelegramSendmessageToolInput(BaseModel):
...
class TelegramSendmessageTool(BaseTool):
    ...
    description = "Tool for telegram sendMessage operation - sendMessage operation"
    ...
    def _run(self, **kwargs):
        """Run the telegram sendMessage operation."""
        ...
        if credentials:
            ...
            return f"Running telegram sendMessage operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram sendMessage operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the telegram sendMessage operation asynchronously."""
