...
class TelegramSenddocumentTool(BaseTool):
    ...
    description = "Tool for telegram sendDocument operation - sendDocument operation"
    ...
    def _run(self, **kwargs):
        """Run the telegram sendDocument operation."""
        ...
        if credentials:
            ...
            return f"Running telegram sendDocument operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram sendDocument operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the telegram sendDocument operation asynchronously."""
