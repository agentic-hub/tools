...
class TelegramAdministratorsToolInput(BaseModel):
...
class TelegramAdministratorsTool(BaseTool):
    name = "telegram_administrators"
    description = "Tool for telegram administrators operation - administrators operation"
    ...
    def _run(self, **kwargs):
        """Run the telegram administrators operation."""
        ...
        if credentials:
            ...
            return f"Running telegram administrators operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram administrators operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the telegram administrators operation asynchronously."""
