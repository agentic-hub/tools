...
class TelegramAnswerinlinequeryTool(BaseTool):
    name = "telegram_answerinlinequery"
    description = "Tool for telegram answerInlineQuery operation - answerInlineQuery operation"
    ...
    def _run(self, **kwargs):
        """Run the telegram answerInlineQuery operation."""
        ...
        if credentials:
            ...
            return f"Running telegram answerInlineQuery operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram answerInlineQuery operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the telegram answerInlineQuery operation asynchronously."""
