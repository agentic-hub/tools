...
class TelegramDeletemessageToolInput(BaseModel):
...
class TelegramDeletemessageTool(BaseTool):
    ...
    description = "Tool for telegram deleteMessage operation - deleteMessage operation"
    ...
    def _run(self, **kwargs):
        """Run the telegram deleteMessage operation."""
        ...
        if credentials:
            ...
            return f"Running telegram deleteMessage operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram deleteMessage operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the telegram deleteMessage operation asynchronously."""
