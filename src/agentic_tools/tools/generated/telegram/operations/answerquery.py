...
class TelegramAnswerqueryTool(BaseTool):
    name = "telegram_answerquery"
    description = "Tool for telegram answerQuery operation - answerQuery operation"
    ...
    def _run(self, **kwargs):
        """Run the telegram answerQuery operation."""
        ...
        if credentials:
            ...
            return f"Running telegram answerQuery operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram answerQuery operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the telegram answerQuery operation asynchronously."""
