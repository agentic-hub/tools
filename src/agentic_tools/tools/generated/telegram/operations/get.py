...
class TelegramGetToolInput(BaseModel):
    ...
    file_id: Optional[str] = Field(None, description="The ID of the file")
...
class TelegramGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running telegram get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram get operation with default credentials and args: {kwargs}"
