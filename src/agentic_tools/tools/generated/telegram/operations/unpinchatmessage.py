...
class TelegramUnpinchatmessageToolInput(BaseModel):
    ...
    message_id: Optional[str] = Field(None, description="Unique identifier of the message to pin or unpin")
...
class TelegramUnpinchatmessageTool(BaseTool):
    ...
    description = "Tool for telegram unpinChatMessage operation - unpinChatMessage operation"
    ...
    def _run(self, **kwargs):
        """Run the telegram unpinChatMessage operation."""
        ...
        if credentials:
            ...
            return f"Running telegram unpinChatMessage operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram unpinChatMessage operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the telegram unpinChatMessage operation asynchronously."""
