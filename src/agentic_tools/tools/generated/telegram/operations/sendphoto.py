...
class TelegramSendphotoTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running telegram sendPhoto operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram sendPhoto operation with default credentials and args: {kwargs}"
