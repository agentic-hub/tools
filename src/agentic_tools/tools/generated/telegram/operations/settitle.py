...
class TelegramSettitleTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running telegram setTitle operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram setTitle operation with default credentials and args: {kwargs}"
