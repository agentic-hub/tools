...
class TelegramSendanimationTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running telegram sendAnimation operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram sendAnimation operation with default credentials and args: {kwargs}"
