...
class TelegramLeaveTool(BaseTool):
    name = "telegram_leave"
    description = "Tool for telegram leave operation - leave operation"
    ...
    def _run(self, **kwargs):
        """Run the telegram leave operation."""
        ...
        if credentials:
            ...
            return f"Running telegram leave operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram leave operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the telegram leave operation asynchronously."""
