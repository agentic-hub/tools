...
class TelegramSendlocationTool(BaseTool):
    ...
    description = "Tool for telegram sendLocation operation - sendLocation operation"
    ...
    def _run(self, **kwargs):
        """Run the telegram sendLocation operation."""
        ...
        if credentials:
            ...
            return f"Running telegram sendLocation operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running telegram sendLocation operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the telegram sendLocation operation asynchronously."""
