...
class TwistDeleteTool(BaseTool):
    name = "twist_delete"
    description = "Tool for twist delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the twist delete operation."""
        ...
        if credentials:
            ...
            return f"Running twist delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running twist delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the twist delete operation asynchronously."""
