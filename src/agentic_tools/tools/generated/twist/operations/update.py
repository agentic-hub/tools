...
class TwistUpdateToolInput(BaseModel):
...
class TwistUpdateTool(BaseTool):
    name = "twist_update"
    description = "Tool for twist update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the twist update operation."""
        ...
        if credentials:
            ...
            return f"Running twist update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running twist update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the twist update operation asynchronously."""
