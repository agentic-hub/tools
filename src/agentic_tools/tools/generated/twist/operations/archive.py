...
class TwistArchiveToolInput(BaseModel):
...
class TwistArchiveTool(BaseTool):
    name = "twist_archive"
    description = "Tool for twist archive operation - archive operation"
    ...
    def _run(self, **kwargs):
        """Run the twist archive operation."""
        ...
        if credentials:
            ...
            return f"Running twist archive operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running twist archive operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the twist archive operation asynchronously."""
