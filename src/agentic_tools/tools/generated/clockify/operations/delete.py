...
class ClockifyDeleteTool(BaseTool):
    name = "clockify_delete"
    description = "Tool for clockify delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the clockify delete operation."""
        ...
        if credentials:
            ...
            return f"Running clockify delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running clockify delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the clockify delete operation asynchronously."""
