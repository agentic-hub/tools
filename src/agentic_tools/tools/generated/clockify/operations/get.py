...
class ClockifyGetToolInput(BaseModel):
    ...
    task_id: Optional[str] = Field(None, description="ID of task to get")
...
class ClockifyGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running clockify get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running clockify get operation with default credentials and args: {kwargs}"
