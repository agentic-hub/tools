...
class AwselbGetmanyTool(BaseTool):
    name = "awselb_getmany"
    description = "Tool for awsElb getMany operation - getMany operation"
    ...
    def _run(self, **kwargs):
        """Run the awsElb getMany operation."""
        ...
        if credentials:
            ...
            return f"Running awsElb getMany operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running awsElb getMany operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the awsElb getMany operation asynchronously."""
