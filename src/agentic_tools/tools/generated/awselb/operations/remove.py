...
class AwselbRemoveTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running awsElb remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running awsElb remove operation with default credentials and args: {kwargs}"
