...
class PostgresUpsertTool(BaseTool):
    ...
    description = "Tool for postgres upsert operation - upsert operation"
    ...
    def _run(self, **kwargs):
        """Run the postgres upsert operation."""
        ...
        if credentials:
            ...
            return f"Running postgres upsert operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running postgres upsert operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the postgres upsert operation asynchronously."""
