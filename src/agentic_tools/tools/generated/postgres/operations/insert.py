...
class PostgresInsertToolInput(BaseModel):
...
class PostgresInsertTool(BaseTool):
    ...
    description = "Tool for postgres insert operation - insert operation"
    ...
    def _run(self, **kwargs):
        """Run the postgres insert operation."""
        ...
        if credentials:
            ...
            return f"Running postgres insert operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running postgres insert operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the postgres insert operation asynchronously."""
