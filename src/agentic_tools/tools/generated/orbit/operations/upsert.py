...
class OrbitUpsertTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running orbit upsert operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running orbit upsert operation with default credentials and args: {kwargs}"
