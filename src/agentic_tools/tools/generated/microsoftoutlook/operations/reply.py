...
class MicrosoftoutlookReplyTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running microsoftOutlook reply operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftOutlook reply operation with default credentials and args: {kwargs}"
