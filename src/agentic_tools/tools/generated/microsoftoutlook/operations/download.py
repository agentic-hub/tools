...
class MicrosoftoutlookDownloadToolInput(BaseModel):
    ...
    binary_property_name: Optional[str] = Field(None, description="Put Output in Field")
...
class MicrosoftoutlookDownloadTool(BaseTool):
    name = "microsoftoutlook_download"
    description = "Tool for microsoftOutlook download operation - download operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftOutlook download operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftOutlook download operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftOutlook download operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftOutlook download operation asynchronously."""
