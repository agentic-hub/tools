...
class MicrosoftoutlookMoveToolInput(BaseModel):
    ...
    folder_id: Optional[Dict[str, Any]] = Field(None, description="Parent Folder")
...
class MicrosoftoutlookMoveTool(BaseTool):
    name = "microsoftoutlook_move"
    description = "Tool for microsoftOutlook move operation - move operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftOutlook move operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftOutlook move operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftOutlook move operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftOutlook move operation asynchronously."""
