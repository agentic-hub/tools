...
class MicrosoftoutlookAddToolInput(BaseModel):
...
class MicrosoftoutlookAddTool(BaseTool):
    name = "microsoftoutlook_add"
    description = "Tool for microsoftOutlook add operation - add operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftOutlook add operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftOutlook add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftOutlook add operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftOutlook add operation asynchronously."""
