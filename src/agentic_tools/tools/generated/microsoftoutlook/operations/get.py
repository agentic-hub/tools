...
class MicrosoftoutlookGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running microsoftOutlook get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftOutlook get operation with default credentials and args: {kwargs}"
