...
class PaddleRescheduleTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running paddle reschedule operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running paddle reschedule operation with default credentials and args: {kwargs}"
