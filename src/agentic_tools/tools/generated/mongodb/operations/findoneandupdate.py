...
class MongodbFindoneandupdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mongoDb findOneAndUpdate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mongoDb findOneAndUpdate operation with default credentials and args: {kwargs}"
