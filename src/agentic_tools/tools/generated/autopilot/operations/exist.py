...
class AutopilotExistTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running autopilot exist operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running autopilot exist operation with default credentials and args: {kwargs}"
