...
class AutopilotRemoveTool(BaseTool):
    name = "autopilot_remove"
    description = "Tool for autopilot remove operation - remove operation"
    ...
    def _run(self, **kwargs):
        """Run the autopilot remove operation."""
        ...
        if credentials:
            ...
            return f"Running autopilot remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running autopilot remove operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the autopilot remove operation asynchronously."""
