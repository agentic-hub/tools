...
class ZohocrmDeleteToolInput(BaseModel):
    ...
    vendor_id: Optional[str] = Field(None, description="ID of the vendor to delete")
...
class ZohocrmDeleteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running zohoCrm delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zohoCrm delete operation with default credentials and args: {kwargs}"
