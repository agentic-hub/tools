...
class ZohocrmGetallToolInput(BaseModel):
...
class ZohocrmGetallTool(BaseTool):
    name = "zohocrm_getall"
    description = "Tool for zohoCrm getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the zohoCrm getAll operation."""
        ...
        if credentials:
            ...
            return f"Running zohoCrm getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zohoCrm getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the zohoCrm getAll operation asynchronously."""
