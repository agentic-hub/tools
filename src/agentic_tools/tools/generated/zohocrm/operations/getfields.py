...
class ZohocrmGetfieldsTool(BaseTool):
    ...
    description = "Tool for zohoCrm getFields operation - getFields operation"
    ...
    def _run(self, **kwargs):
        """Run the zohoCrm getFields operation."""
        ...
        if credentials:
            ...
            return f"Running zohoCrm getFields operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zohoCrm getFields operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the zohoCrm getFields operation asynchronously."""
