...
class ZohocrmUpsertTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running zohoCrm upsert operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zohoCrm upsert operation with default credentials and args: {kwargs}"
