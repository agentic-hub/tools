...
class OdooCreateTool(BaseTool):
    name = "odoo_create"
    description = "Tool for odoo create operation - create operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running odoo create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running odoo create operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the odoo create operation asynchronously."""
