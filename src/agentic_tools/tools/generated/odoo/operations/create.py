...
class OdooCreateToolInput(BaseModel):
    ...
    opportunityName: Optional[str] = Field(None, description="Name")
    resource: Optional[str] = Field(None, description="Resource")
    additionalFields: Optional[Dict[str, Any]] = Field(None, description="Additional Fields")
    contactId: Optional[str] = Field(None, description="Contact ID")
    contactName: Optional[str] = Field(None, description="Name")
...
class OdooCreateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running odoo create operation with args: {kwargs}"
