...
class OdooDeleteToolInput(BaseModel):
...
class OdooDeleteTool(BaseTool):
    name = "odoo_delete"
    description = "Tool for odoo delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running odoo delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running odoo delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the odoo delete operation asynchronously."""
