...
class OdooUpdateToolInput(BaseModel):
    ...
    fields_to_create_or_update: Optional[Dict[str, Any]] = Field(None, description="Update Fields")
...
class OdooUpdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running odoo update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running odoo update operation with default credentials and args: {kwargs}"
