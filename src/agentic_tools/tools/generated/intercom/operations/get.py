...
class IntercomGetTool(BaseTool):
    name = "intercom_get"
    description = "Tool for intercom get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the intercom get operation."""
        ...
        if credentials:
            ...
            return f"Running intercom get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running intercom get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the intercom get operation asynchronously."""
