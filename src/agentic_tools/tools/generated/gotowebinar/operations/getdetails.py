...
class GotowebinarGetdetailsTool(BaseTool):
    name = "gotowebinar_getdetails"
    description = "Tool for goToWebinar getDetails operation - getDetails operation"
    ...
    def _run(self, **kwargs):
        """Run the goToWebinar getDetails operation."""
        ...
        if credentials:
            ...
            return f"Running goToWebinar getDetails operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running goToWebinar getDetails operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the goToWebinar getDetails operation asynchronously."""
