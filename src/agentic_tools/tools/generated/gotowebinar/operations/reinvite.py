...
class GotowebinarReinviteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running goToWebinar reinvite operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running goToWebinar reinvite operation with default credentials and args: {kwargs}"
