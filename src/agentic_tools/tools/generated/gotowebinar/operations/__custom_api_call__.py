...
class Gotowebinar__custom_api_call__ToolInput(BaseModel):
...
class Gotowebinar__custom_api_call__Tool(BaseTool):
    name = "gotowebinar___custom_api_call__"
    description = "Tool for goToWebinar __CUSTOM_API_CALL__ operation - __CUSTOM_API_CALL__ operation"
    ...
    def _run(self, **kwargs):
        """Run the goToWebinar __CUSTOM_API_CALL__ operation."""
        ...
        if credentials:
            ...
            return f"Running goToWebinar __CUSTOM_API_CALL__ operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running goToWebinar __CUSTOM_API_CALL__ operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the goToWebinar __CUSTOM_API_CALL__ operation asynchronously."""
