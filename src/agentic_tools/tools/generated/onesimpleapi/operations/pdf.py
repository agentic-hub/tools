...
class OnesimpleapiPdfTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running oneSimpleApi pdf operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running oneSimpleApi pdf operation with default credentials and args: {kwargs}"
