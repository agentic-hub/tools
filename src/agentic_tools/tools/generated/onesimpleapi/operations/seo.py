...
class OnesimpleapiSeoTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running oneSimpleApi seo operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running oneSimpleApi seo operation with default credentials and args: {kwargs}"
