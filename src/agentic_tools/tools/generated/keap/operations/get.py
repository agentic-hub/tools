...
class KeapGetTool(BaseTool):
    name = "keap_get"
    description = "Tool for keap get operation - get operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running keap get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running keap get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the keap get operation asynchronously."""
