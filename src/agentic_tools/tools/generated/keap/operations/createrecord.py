...
class KeapCreaterecordToolInput(BaseModel):
    ...
    sentFromAddress: Optional[str] = Field(None, description="Sent From Address")
    operation: Optional[str] = Field(None, description="Operation")
    phonesUi: Optional[Dict[str, Any]] = Field(None, description="Phones")
    limit: Optional[float] = Field(None, description="Max number of results to return")
    options: Optional[Dict[str, Any]] = Field(None, description="Options")
    sentToAddress: Optional[str] = Field(None, description="Sent To Address")
...
class KeapCreaterecordTool(BaseTool):
    name = "keap_createrecord"
    description = "Tool for keap createRecord operation - createRecord operation"
    
    def _run(self, **kwargs):
        """Run the keap createRecord operation."""
        # Implement the tool logic here
        return f"Running keap createRecord operation with args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the keap createRecord operation asynchronously."""
