...
class KeapCreaterecordTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running keap createRecord operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running keap createRecord operation with default credentials and args: {kwargs}"
