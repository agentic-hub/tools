...
class KeapGetallToolInput(BaseModel):
...
class KeapGetallTool(BaseTool):
    name = "keap_getall"
    description = "Tool for keap getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running keap getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running keap getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the keap getAll operation asynchronously."""
