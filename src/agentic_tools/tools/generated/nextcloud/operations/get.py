...
class NextcloudGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running nextCloud get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running nextCloud get operation with default credentials and args: {kwargs}"
