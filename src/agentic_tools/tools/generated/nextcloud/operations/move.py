...
class NextcloudMoveTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running nextCloud move operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running nextCloud move operation with default credentials and args: {kwargs}"
