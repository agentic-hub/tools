...
class VeroAliasTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running vero alias operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running vero alias operation with default credentials and args: {kwargs}"
