...
class VeroRemovetagsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running vero removeTags operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running vero removeTags operation with default credentials and args: {kwargs}"
