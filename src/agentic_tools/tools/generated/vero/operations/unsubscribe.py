...
class VeroUnsubscribeTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running vero unsubscribe operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running vero unsubscribe operation with default credentials and args: {kwargs}"
