...
class VeroAddtagsTool(BaseTool):
    name = "vero_addtags"
    description = "Tool for vero addTags operation - addTags operation"
    ...
    def _run(self, **kwargs):
        """Run the vero addTags operation."""
        ...
        if credentials:
            ...
            return f"Running vero addTags operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running vero addTags operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the vero addTags operation asynchronously."""
