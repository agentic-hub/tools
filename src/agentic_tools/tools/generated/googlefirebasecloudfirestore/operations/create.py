...
class GooglefirebasecloudfirestoreCreateTool(BaseTool):
    name = "googlefirebasecloudfirestore_create"
    description = "Tool for googleFirebaseCloudFirestore create operation - create operation"
    ...
    def _run(self, **kwargs):
        """Run the googleFirebaseCloudFirestore create operation."""
        ...
        if credentials:
            ...
            return f"Running googleFirebaseCloudFirestore create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleFirebaseCloudFirestore create operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the googleFirebaseCloudFirestore create operation asynchronously."""
