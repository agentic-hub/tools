...
class GooglefirebasecloudfirestoreDeleteToolInput(BaseModel):
...
class GooglefirebasecloudfirestoreDeleteTool(BaseTool):
    name = "googlefirebasecloudfirestore_delete"
    description = "Tool for googleFirebaseCloudFirestore delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the googleFirebaseCloudFirestore delete operation."""
        ...
        if credentials:
            ...
            return f"Running googleFirebaseCloudFirestore delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleFirebaseCloudFirestore delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the googleFirebaseCloudFirestore delete operation asynchronously."""
