...
class GooglefirebasecloudfirestoreUpsertTool(BaseTool):
    name = "googlefirebasecloudfirestore_upsert"
    description = "Tool for googleFirebaseCloudFirestore upsert operation - upsert operation"
    ...
    def _run(self, **kwargs):
        """Run the googleFirebaseCloudFirestore upsert operation."""
        ...
        if credentials:
            ...
            return f"Running googleFirebaseCloudFirestore upsert operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleFirebaseCloudFirestore upsert operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the googleFirebaseCloudFirestore upsert operation asynchronously."""
