...
class PipedriveDuplicateToolInput(BaseModel):
    ...
    deal_id: Optional[float] = Field(None, description="ID of the deal to duplicate")
...
class PipedriveDuplicateTool(BaseTool):
    name = "pipedrive_duplicate"
    description = "Tool for pipedrive duplicate operation - duplicate operation"
    ...
    def _run(self, **kwargs):
        """Run the pipedrive duplicate operation."""
        ...
        if credentials:
            ...
            return f"Running pipedrive duplicate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running pipedrive duplicate operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the pipedrive duplicate operation asynchronously."""
