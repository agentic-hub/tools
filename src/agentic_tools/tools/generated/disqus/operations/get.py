...
class DisqusGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running disqus get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running disqus get operation with default credentials and args: {kwargs}"
