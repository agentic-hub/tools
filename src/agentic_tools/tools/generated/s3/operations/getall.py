...
class S3GetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running s3 getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running s3 getAll operation with default credentials and args: {kwargs}"
