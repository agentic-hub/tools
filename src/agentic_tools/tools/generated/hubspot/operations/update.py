...
class HubspotUpdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running hubspot update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running hubspot update operation with default credentials and args: {kwargs}"
