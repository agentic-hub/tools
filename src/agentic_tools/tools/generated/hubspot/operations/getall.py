...
class HubspotGetallToolInput(BaseModel):
...
class HubspotGetallTool(BaseTool):
    name = "hubspot_getall"
    description = "Tool for hubspot getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the hubspot getAll operation."""
        ...
        if credentials:
            ...
            return f"Running hubspot getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running hubspot getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the hubspot getAll operation asynchronously."""
