...
class HubspotDeleteToolInput(BaseModel):
    ...
    engagement_id: Optional[Dict[str, Any]] = Field(None, description="Engagement to Delete")
    email: Optional[str] = Field(None, description="Email")
    ticket_id: Optional[Dict[str, Any]] = Field(None, description="Ticket to Delete")
    id: Optional[float] = Field(None, description="Contact to Add")
    company_id: Optional[Dict[str, Any]] = Field(None, description="Company to Delete")
    ...
    deal_id: Optional[Dict[str, Any]] = Field(None, description="Deal to Delete")
...
class HubspotDeleteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running hubspot delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running hubspot delete operation with default credentials and args: {kwargs}"
