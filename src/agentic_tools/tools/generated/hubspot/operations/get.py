...
class HubspotGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running hubspot get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running hubspot get operation with default credentials and args: {kwargs}"
