...
class HubspotUpsertToolInput(BaseModel):
...
class HubspotUpsertTool(BaseTool):
    name = "hubspot_upsert"
    description = "Tool for hubspot upsert operation - upsert operation"
    ...
    def _run(self, **kwargs):
        """Run the hubspot upsert operation."""
        ...
        if credentials:
            ...
            return f"Running hubspot upsert operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running hubspot upsert operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the hubspot upsert operation asynchronously."""
