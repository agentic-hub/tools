...
class HubspotAddToolInput(BaseModel):
    ...
    by: Optional[str] = Field(None, description="By")
...
class HubspotAddTool(BaseTool):
    name = "hubspot_add"
    description = "Tool for hubspot add operation - add operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running hubspot add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running hubspot add operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the hubspot add operation asynchronously."""
