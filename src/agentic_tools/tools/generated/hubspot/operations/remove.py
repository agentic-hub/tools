...
class HubspotRemoveToolInput(BaseModel):
    ...
    id: Optional[float] = Field(None, description="Contact to Remove")
    company_id: Optional[Dict[str, Any]] = Field(None, description="Company to Update")
    operation: Optional[str] = Field(None, description="Operation")
    limit: Optional[float] = Field(None, description="Max number of results to return")
    list_id: Optional[float] = Field(None, description="List to Remove From")
...
class HubspotRemoveTool(BaseTool):
    name = "hubspot_remove"
    description = "Tool for hubspot remove operation - remove operation"
    ...
    def _run(self, **kwargs):
        """Run the hubspot remove operation."""
        ...
        if credentials:
            ...
            return f"Running hubspot remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running hubspot remove operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the hubspot remove operation asynchronously."""
