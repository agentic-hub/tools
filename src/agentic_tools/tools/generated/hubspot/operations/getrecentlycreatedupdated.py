...
class HubspotGetrecentlycreatedupdatedTool(BaseTool):
    name = "hubspot_getrecentlycreatedupdated"
    description = "Tool for hubspot getRecentlyCreatedUpdated operation - getRecentlyCreatedUpdated operation"
    ...
    def _run(self, **kwargs):
        """Run the hubspot getRecentlyCreatedUpdated operation."""
        ...
        if credentials:
            ...
            return f"Running hubspot getRecentlyCreatedUpdated operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running hubspot getRecentlyCreatedUpdated operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the hubspot getRecentlyCreatedUpdated operation asynchronously."""
