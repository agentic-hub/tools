...
class LemlistCreateTool(BaseTool):
    name = "lemlist_create"
    description = "Tool for lemlist create operation - create operation"
    ...
    def _run(self, **kwargs):
        """Run the lemlist create operation."""
        ...
        if credentials:
            ...
            return f"Running lemlist create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running lemlist create operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the lemlist create operation asynchronously."""
