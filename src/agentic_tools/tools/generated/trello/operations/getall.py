...
class TrelloGetallToolInput(BaseModel):
    ...
    id: Optional[str] = Field(None, description="The ID of the board to get members from")
...
class TrelloGetallTool(BaseTool):
    name = "trello_getall"
    description = "Tool for trello getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the trello getAll operation."""
        ...
        if credentials:
            ...
            return f"Running trello getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running trello getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the trello getAll operation asynchronously."""
