...
class TrelloCreateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running trello create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running trello create operation with default credentials and args: {kwargs}"
