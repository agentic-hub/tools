...
class TrelloGetcardsToolInput(BaseModel):
    ...
    id: Optional[str] = Field(None, description="The ID of the list to get cards")
...
class TrelloGetcardsTool(BaseTool):
    ...
    description = "Tool for trello getCards operation - getCards operation"
    ...
    def _run(self, **kwargs):
        """Run the trello getCards operation."""
        ...
        if credentials:
            ...
            return f"Running trello getCards operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running trello getCards operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the trello getCards operation asynchronously."""
