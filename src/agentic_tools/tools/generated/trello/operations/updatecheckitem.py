...
class TrelloUpdatecheckitemToolInput(BaseModel):
    ...
    check_item_id: Optional[str] = Field(None, description="The ID of the checklist item to update")
...
class TrelloUpdatecheckitemTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running trello updateCheckItem operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running trello updateCheckItem operation with default credentials and args: {kwargs}"
