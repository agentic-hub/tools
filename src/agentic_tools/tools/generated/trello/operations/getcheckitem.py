...
class TrelloGetcheckitemToolInput(BaseModel):
    ...
    check_item_id: Optional[str] = Field(None, description="The ID of the checklist item to get")
...
class TrelloGetcheckitemTool(BaseTool):
    name = "trello_getcheckitem"
    description = "Tool for trello getCheckItem operation - getCheckItem operation"
    ...
    def _run(self, **kwargs):
        """Run the trello getCheckItem operation."""
        ...
        if credentials:
            ...
            return f"Running trello getCheckItem operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running trello getCheckItem operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the trello getCheckItem operation asynchronously."""
