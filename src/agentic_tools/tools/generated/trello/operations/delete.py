...
class TrelloDeleteToolInput(BaseModel):
...
class TrelloDeleteTool(BaseTool):
    name = "trello_delete"
    description = "Tool for trello delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the trello delete operation."""
        ...
        if credentials:
            ...
            return f"Running trello delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running trello delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the trello delete operation asynchronously."""
