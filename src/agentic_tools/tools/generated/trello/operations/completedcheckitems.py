...
class TrelloCompletedcheckitemsToolInput(BaseModel):
...
class TrelloCompletedcheckitemsTool(BaseTool):
    name = "trello_completedcheckitems"
    description = "Tool for trello completedCheckItems operation - completedCheckItems operation"
    ...
    def _run(self, **kwargs):
        """Run the trello completedCheckItems operation."""
        ...
        if credentials:
            ...
            return f"Running trello completedCheckItems operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running trello completedCheckItems operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the trello completedCheckItems operation asynchronously."""
