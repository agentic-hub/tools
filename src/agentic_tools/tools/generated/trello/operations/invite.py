...
class TrelloInviteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running trello invite operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running trello invite operation with default credentials and args: {kwargs}"
