...
class TrelloAddTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running trello add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running trello add operation with default credentials and args: {kwargs}"
