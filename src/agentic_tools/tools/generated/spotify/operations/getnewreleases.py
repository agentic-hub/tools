...
class SpotifyGetnewreleasesTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running spotify getNewReleases operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running spotify getNewReleases operation with default credentials and args: {kwargs}"
