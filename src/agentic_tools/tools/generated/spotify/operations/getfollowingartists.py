...
class SpotifyGetfollowingartistsTool(BaseTool):
    name = "spotify_getfollowingartists"
    description = "Tool for spotify getFollowingArtists operation - getFollowingArtists operation"
    ...
    def _run(self, **kwargs):
        """Run the spotify getFollowingArtists operation."""
        ...
        if credentials:
            ...
            return f"Running spotify getFollowingArtists operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running spotify getFollowingArtists operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the spotify getFollowingArtists operation asynchronously."""
