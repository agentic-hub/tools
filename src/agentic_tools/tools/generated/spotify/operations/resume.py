...
class SpotifyResumeTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running spotify resume operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running spotify resume operation with default credentials and args: {kwargs}"
