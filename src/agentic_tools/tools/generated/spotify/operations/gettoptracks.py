...
class SpotifyGettoptracksTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running spotify getTopTracks operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running spotify getTopTracks operation with default credentials and args: {kwargs}"
