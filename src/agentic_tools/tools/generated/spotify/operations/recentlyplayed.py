...
class SpotifyRecentlyplayedTool(BaseTool):
    name = "spotify_recentlyplayed"
    description = "Tool for spotify recentlyPlayed operation - recentlyPlayed operation"
    ...
    def _run(self, **kwargs):
        """Run the spotify recentlyPlayed operation."""
        ...
        if credentials:
            ...
            return f"Running spotify recentlyPlayed operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running spotify recentlyPlayed operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the spotify recentlyPlayed operation asynchronously."""
