...
class SpotifySearchToolInput(BaseModel):
...
class SpotifySearchTool(BaseTool):
    name = "spotify_search"
    description = "Tool for spotify search operation - search operation"
    ...
    def _run(self, **kwargs):
        """Run the spotify search operation."""
        ...
        if credentials:
            ...
            return f"Running spotify search operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running spotify search operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the spotify search operation asynchronously."""
