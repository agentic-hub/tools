...
class QuickbaseUpdateToolInput(BaseModel):
...
class QuickbaseUpdateTool(BaseTool):
    name = "quickbase_update"
    description = "Tool for quickbase update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the quickbase update operation."""
        ...
        if credentials:
            ...
            return f"Running quickbase update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running quickbase update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the quickbase update operation asynchronously."""
