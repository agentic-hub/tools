...
class QuickbaseGetToolInput(BaseModel):
...
class QuickbaseGetTool(BaseTool):
    name = "quickbase_get"
    description = "Tool for quickbase get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the quickbase get operation."""
        ...
        if credentials:
            ...
            return f"Running quickbase get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running quickbase get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the quickbase get operation asynchronously."""
