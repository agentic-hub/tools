...
class TravisciRestartTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running travisCi restart operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running travisCi restart operation with default credentials and args: {kwargs}"
