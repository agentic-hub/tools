...
class ActionnetworkGetallToolInput(BaseModel):
    ...
    petitionId: Optional[str] = Field(None, description="ID of the petition whose signatures to retrieve")
...
class ActionnetworkGetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running actionNetwork getAll operation with args: {kwargs}"
