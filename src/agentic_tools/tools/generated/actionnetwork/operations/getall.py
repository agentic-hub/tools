...
class ActionnetworkGetallTool(BaseTool):
    name = "actionnetwork_getall"
    description = "Tool for actionNetwork getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the actionNetwork getAll operation."""
        ...
        if credentials:
            ...
            return f"Running actionNetwork getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running actionNetwork getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the actionNetwork getAll operation asynchronously."""
