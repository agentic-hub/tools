...
class ActionnetworkRemoveTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running actionNetwork remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running actionNetwork remove operation with default credentials and args: {kwargs}"
