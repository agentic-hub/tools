...
class OuraGetactivityTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running oura getActivity operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running oura getActivity operation with default credentials and args: {kwargs}"
