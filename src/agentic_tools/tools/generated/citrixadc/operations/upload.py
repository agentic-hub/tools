...
class CitrixadcUploadTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running citrixAdc upload operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running citrixAdc upload operation with default credentials and args: {kwargs}"
