...
class CodaGetrowToolInput(BaseModel):
...
class CodaGetrowTool(BaseTool):
    name = "coda_getrow"
    description = "Tool for coda getRow operation - getRow operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running coda getRow operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running coda getRow operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the coda getRow operation asynchronously."""
