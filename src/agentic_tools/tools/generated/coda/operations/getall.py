...
class CodaGetallToolInput(BaseModel):
...
class CodaGetallTool(BaseTool):
    name = "coda_getall"
    description = "Tool for coda getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running coda getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running coda getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the coda getAll operation asynchronously."""
