...
class CodaGetcolumnTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running coda getColumn operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running coda getColumn operation with default credentials and args: {kwargs}"
