...
class CodaPushbuttonToolInput(BaseModel):
...
class CodaPushbuttonTool(BaseTool):
    name = "coda_pushbutton"
    description = "Tool for coda pushButton operation - pushButton operation"
    ...
    def _run(self, **kwargs):
        """Run the coda pushButton operation."""
        ...
        if credentials:
            ...
            return f"Running coda pushButton operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running coda pushButton operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the coda pushButton operation asynchronously."""
