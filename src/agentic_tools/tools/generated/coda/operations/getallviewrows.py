...
class CodaGetallviewrowsTool(BaseTool):
    name = "coda_getallviewrows"
    description = "Tool for coda getAllViewRows operation - getAllViewRows operation"
    ...
    def _run(self, **kwargs):
        """Run the coda getAllViewRows operation."""
        ...
        if credentials:
            ...
            return f"Running coda getAllViewRows operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running coda getAllViewRows operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the coda getAllViewRows operation asynchronously."""
