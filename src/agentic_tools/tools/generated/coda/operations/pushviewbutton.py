...
class CodaPushviewbuttonToolInput(BaseModel):
...
class CodaPushviewbuttonTool(BaseTool):
    name = "coda_pushviewbutton"
    description = "Tool for coda pushViewButton operation - pushViewButton operation"
    ...
    def _run(self, **kwargs):
        """Run the coda pushViewButton operation."""
        ...
        if credentials:
            ...
            return f"Running coda pushViewButton operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running coda pushViewButton operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the coda pushViewButton operation asynchronously."""
