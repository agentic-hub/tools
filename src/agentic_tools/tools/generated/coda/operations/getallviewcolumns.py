...
class CodaGetallviewcolumnsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running coda getAllViewColumns operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running coda getAllViewColumns operation with default credentials and args: {kwargs}"
