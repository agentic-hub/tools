...
class CodaCreaterowTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running coda createRow operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running coda createRow operation with default credentials and args: {kwargs}"
