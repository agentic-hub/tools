...
class WordpressGetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running wordpress getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running wordpress getAll operation with default credentials and args: {kwargs}"
