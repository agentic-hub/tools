...
class MispDeleteTool(BaseTool):
    name = "misp_delete"
    description = "Tool for misp delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running misp delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running misp delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the misp delete operation asynchronously."""
