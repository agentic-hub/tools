...
class MispGetallTool(BaseTool):
    name = "misp_getall"
    description = "Tool for misp getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running misp getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running misp getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the misp getAll operation asynchronously."""
