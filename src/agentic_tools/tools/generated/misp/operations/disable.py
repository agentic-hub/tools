...
class MispDisableToolInput(BaseModel):
...
class MispDisableTool(BaseTool):
    name = "misp_disable"
    description = "Tool for misp disable operation - disable operation"
    ...
    def _run(self, **kwargs):
        """Run the misp disable operation."""
        ...
        if credentials:
            ...
            return f"Running misp disable operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running misp disable operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the misp disable operation asynchronously."""
