...
class MispAddToolInput(BaseModel):
...
class MispAddTool(BaseTool):
    name = "misp_add"
    description = "Tool for misp add operation - add operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running misp add operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running misp add operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the misp add operation asynchronously."""
