...
class MispUnpublishTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running misp unpublish operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running misp unpublish operation with default credentials and args: {kwargs}"
