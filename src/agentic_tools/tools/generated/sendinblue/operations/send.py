...
class SendinblueSendTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running sendInBlue send operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running sendInBlue send operation with default credentials and args: {kwargs}"
