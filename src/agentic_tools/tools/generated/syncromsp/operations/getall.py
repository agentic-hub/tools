...
class SyncromspGetallTool(BaseTool):
    name = "syncromsp_getall"
    description = "Tool for syncroMsp getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the syncroMsp getAll operation."""
        ...
        if credentials:
            ...
            return f"Running syncroMsp getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running syncroMsp getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the syncroMsp getAll operation asynchronously."""
