...
class SyncromspCreateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running syncroMsp create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running syncroMsp create operation with default credentials and args: {kwargs}"
