...
class GoogleslidesGetslidesTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running googleSlides getSlides operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleSlides getSlides operation with default credentials and args: {kwargs}"
