...
class HarvestMeToolInput(BaseModel):
...
class HarvestMeTool(BaseTool):
    name = "harvest_me"
    description = "Tool for harvest me operation - me operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running harvest me operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running harvest me operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the harvest me operation asynchronously."""
