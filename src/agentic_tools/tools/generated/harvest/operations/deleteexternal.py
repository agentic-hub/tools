...
class HarvestDeleteexternalTool(BaseTool):
    name = "harvest_deleteexternal"
    description = "Tool for harvest deleteExternal operation - deleteExternal operation"
    ...
    def _run(self, **kwargs):
        """Run the harvest deleteExternal operation."""
        ...
        if credentials:
            ...
            return f"Running harvest deleteExternal operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running harvest deleteExternal operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the harvest deleteExternal operation asynchronously."""
