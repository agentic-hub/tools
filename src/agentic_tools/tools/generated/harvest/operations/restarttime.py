...
class HarvestRestarttimeTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running harvest restartTime operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running harvest restartTime operation with default credentials and args: {kwargs}"
