...
class IterableRemoveToolInput(BaseModel):
...
class IterableRemoveTool(BaseTool):
    name = "iterable_remove"
    description = "Tool for iterable remove operation - remove operation"
    ...
    def _run(self, **kwargs):
        """Run the iterable remove operation."""
        ...
        if credentials:
            ...
            return f"Running iterable remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running iterable remove operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the iterable remove operation asynchronously."""
