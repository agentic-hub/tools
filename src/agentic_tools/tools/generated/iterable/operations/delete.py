...
class IterableDeleteToolInput(BaseModel):
...
class IterableDeleteTool(BaseTool):
    name = "iterable_delete"
    description = "Tool for iterable delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the iterable delete operation."""
        ...
        if credentials:
            ...
            return f"Running iterable delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running iterable delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the iterable delete operation asynchronously."""
