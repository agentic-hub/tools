...
class CustomerioGetTool(BaseTool):
    name = "customerio_get"
    description = "Tool for customerIo get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the customerIo get operation."""
        ...
        if credentials:
            ...
            return f"Running customerIo get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running customerIo get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the customerIo get operation asynchronously."""
