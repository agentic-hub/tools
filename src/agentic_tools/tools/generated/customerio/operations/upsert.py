...
class CustomerioUpsertTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running customerIo upsert operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running customerIo upsert operation with default credentials and args: {kwargs}"
