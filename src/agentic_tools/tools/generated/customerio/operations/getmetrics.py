...
class CustomerioGetmetricsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running customerIo getMetrics operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running customerIo getMetrics operation with default credentials and args: {kwargs}"
