...
class CustomerioDeleteTool(BaseTool):
    name = "customerio_delete"
    description = "Tool for customerIo delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the customerIo delete operation."""
        ...
        if credentials:
            ...
            return f"Running customerIo delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running customerIo delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the customerIo delete operation asynchronously."""
