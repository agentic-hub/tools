...
class GetresponseDeleteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running getResponse delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running getResponse delete operation with default credentials and args: {kwargs}"
