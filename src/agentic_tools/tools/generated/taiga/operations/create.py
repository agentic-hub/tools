...
class TaigaCreateTool(BaseTool):
    name = "taiga_create"
    description = "Tool for taiga create operation - create operation"
    ...
    def _run(self, **kwargs):
        """Run the taiga create operation."""
        ...
        if credentials:
            ...
            return f"Running taiga create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running taiga create operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the taiga create operation asynchronously."""
