...
class SecurityscorecardGethistoricalscoreTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running securityScorecard getHistoricalScore operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running securityScorecard getHistoricalScore operation with default credentials and args: {kwargs}"
