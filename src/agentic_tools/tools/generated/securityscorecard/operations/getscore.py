...
class SecurityscorecardGetscoreTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running securityScorecard getScore operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running securityScorecard getScore operation with default credentials and args: {kwargs}"
