...
class JenkinsSafeexitTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running jenkins safeExit operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jenkins safeExit operation with default credentials and args: {kwargs}"
