...
class JenkinsCancelquietdownTool(BaseTool):
    name = "jenkins_cancelquietdown"
    description = "Tool for jenkins cancelQuietDown operation - cancelQuietDown operation"
    ...
    def _run(self, **kwargs):
        """Run the jenkins cancelQuietDown operation."""
        ...
        if credentials:
            ...
            return f"Running jenkins cancelQuietDown operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jenkins cancelQuietDown operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the jenkins cancelQuietDown operation asynchronously."""
