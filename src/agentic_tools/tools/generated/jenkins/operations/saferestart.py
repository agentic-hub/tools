...
class JenkinsSaferestartTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running jenkins safeRestart operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jenkins safeRestart operation with default credentials and args: {kwargs}"
