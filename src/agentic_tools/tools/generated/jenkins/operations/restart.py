...
class JenkinsRestartTool(BaseTool):
    ...
    description = "Tool for jenkins restart operation - restart operation"
    ...
    def _run(self, **kwargs):
        """Run the jenkins restart operation."""
        ...
        if credentials:
            ...
            return f"Running jenkins restart operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running jenkins restart operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the jenkins restart operation asynchronously."""
