...
class StoryblokDeleteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running storyblok delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running storyblok delete operation with default credentials and args: {kwargs}"
