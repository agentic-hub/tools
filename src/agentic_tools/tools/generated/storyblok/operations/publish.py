...
class StoryblokPublishTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running storyblok publish operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running storyblok publish operation with default credentials and args: {kwargs}"
