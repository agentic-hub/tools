...
class ActivecampaignUpdatenoteToolInput(BaseModel):
    ...
    deal_note_id: Optional[float] = Field(None, description="The ID of the deal note")
    ...
    deal_id: Optional[float] = Field(None, description="The ID of the deal note")
...
class ActivecampaignUpdatenoteTool(BaseTool):
    name = "activecampaign_updatenote"
    description = "Tool for activeCampaign updateNote operation - updateNote operation"
    ...
    def _run(self, **kwargs):
        """Run the activeCampaign updateNote operation."""
        ...
        if credentials:
            ...
            return f"Running activeCampaign updateNote operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running activeCampaign updateNote operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the activeCampaign updateNote operation asynchronously."""
