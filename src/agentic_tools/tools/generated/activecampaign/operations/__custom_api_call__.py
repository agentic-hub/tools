...
class Activecampaign__custom_api_call__ToolInput(BaseModel):
...
class Activecampaign__custom_api_call__Tool(BaseTool):
    name = "activecampaign___custom_api_call__"
    description = "Tool for activeCampaign __CUSTOM_API_CALL__ operation - __CUSTOM_API_CALL__ operation"
    ...
    def _run(self, **kwargs):
        """Run the activeCampaign __CUSTOM_API_CALL__ operation."""
        ...
        if credentials:
            ...
            return f"Running activeCampaign __CUSTOM_API_CALL__ operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running activeCampaign __CUSTOM_API_CALL__ operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the activeCampaign __CUSTOM_API_CALL__ operation asynchronously."""
