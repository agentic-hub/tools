...
class ActivecampaignUpdateToolInput(BaseModel):
    ...
    accountContactId: Optional[float] = Field(None, description="Account ID")
    ...
    contactId: Optional[float] = Field(None, description="ID of the contact to update")
...
class ActivecampaignUpdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running activeCampaign update operation with args: {kwargs}"
