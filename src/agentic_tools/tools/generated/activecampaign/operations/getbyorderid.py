...
class ActivecampaignGetbyorderidToolInput(BaseModel):
    ...
    order_id: Optional[float] = Field(None, description="The ID of the order whose products you'd like returned")
...
class ActivecampaignGetbyorderidTool(BaseTool):
    name = "activecampaign_getbyorderid"
    description = "Tool for activeCampaign getByOrderId operation - getByOrderId operation"
    ...
    def _run(self, **kwargs):
        """Run the activeCampaign getByOrderId operation."""
        ...
        if credentials:
            ...
            return f"Running activeCampaign getByOrderId operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running activeCampaign getByOrderId operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the activeCampaign getByOrderId operation asynchronously."""
