...
class ActivecampaignRemoveTool(BaseTool):
    name = "activecampaign_remove"
    description = "Tool for activeCampaign remove operation - remove operation"
    ...
    def _run(self, **kwargs):
        """Run the activeCampaign remove operation."""
        ...
        if credentials:
            ...
            return f"Running activeCampaign remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running activeCampaign remove operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the activeCampaign remove operation asynchronously."""
