...
class RedisInfoTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running redis info operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running redis info operation with default credentials and args: {kwargs}"
