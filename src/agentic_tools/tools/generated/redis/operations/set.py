...
class RedisSetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running redis set operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running redis set operation with default credentials and args: {kwargs}"
