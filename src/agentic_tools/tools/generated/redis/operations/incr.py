...
class RedisIncrTool(BaseTool):
    name = "redis_incr"
    description = "Tool for redis incr operation - incr operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running redis incr operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running redis incr operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the redis incr operation asynchronously."""
