...
class Magento2UpdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running magento2 update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running magento2 update operation with default credentials and args: {kwargs}"
