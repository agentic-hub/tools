...
class Magento2GetToolInput(BaseModel):
...
class Magento2GetTool(BaseTool):
    name = "magento2_get"
    description = "Tool for magento2 get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the magento2 get operation."""
        ...
        if credentials:
            ...
            return f"Running magento2 get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running magento2 get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the magento2 get operation asynchronously."""
