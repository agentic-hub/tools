...
class Magento2GetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running magento2 getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running magento2 getAll operation with default credentials and args: {kwargs}"
