...
class Magento2ShipToolInput(BaseModel):
...
class Magento2ShipTool(BaseTool):
    name = "magento2_ship"
    description = "Tool for magento2 ship operation - ship operation"
    ...
    def _run(self, **kwargs):
        """Run the magento2 ship operation."""
        ...
        if credentials:
            ...
            return f"Running magento2 ship operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running magento2 ship operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the magento2 ship operation asynchronously."""
