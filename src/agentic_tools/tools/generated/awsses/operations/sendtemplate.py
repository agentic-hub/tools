...
class AwssesSendtemplateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running awsSes sendTemplate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running awsSes sendTemplate operation with default credentials and args: {kwargs}"
