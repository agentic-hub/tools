...
class XeroUpdateTool(BaseTool):
    name = "xero_update"
    description = "Tool for xero update operation - update operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running xero update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running xero update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the xero update operation asynchronously."""
