...
class RundeckExecuteTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running rundeck execute operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running rundeck execute operation with default credentials and args: {kwargs}"
