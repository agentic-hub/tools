...
class WoocommerceUpdateToolInput(BaseModel):
...
class WoocommerceUpdateTool(BaseTool):
    name = "woocommerce_update"
    description = "Tool for wooCommerce update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the wooCommerce update operation."""
        ...
        if credentials:
            ...
            return f"Running wooCommerce update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running wooCommerce update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the wooCommerce update operation asynchronously."""
