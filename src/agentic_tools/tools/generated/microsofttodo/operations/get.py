...
class MicrosofttodoGetTool(BaseTool):
    name = "microsofttodo_get"
    description = "Tool for microsoftToDo get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftToDo get operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftToDo get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftToDo get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftToDo get operation asynchronously."""
