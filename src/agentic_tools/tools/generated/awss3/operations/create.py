...
class Awss3CreateTool(BaseTool):
    name = "awss3_create"
    description = "Tool for awsS3 create operation - create operation"
    ...
    def _run(self, **kwargs):
        """Run the awsS3 create operation."""
        ...
        if credentials:
            ...
            return f"Running awsS3 create operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running awsS3 create operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the awsS3 create operation asynchronously."""
