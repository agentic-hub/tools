...
class Awss3SearchTool(BaseTool):
    name = "awss3_search"
    description = "Tool for awsS3 search operation - search operation"
    ...
    def _run(self, **kwargs):
        """Run the awsS3 search operation."""
        ...
        if credentials:
            ...
            return f"Running awsS3 search operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running awsS3 search operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the awsS3 search operation asynchronously."""
