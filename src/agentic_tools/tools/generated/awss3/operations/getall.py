...
class Awss3GetallTool(BaseTool):
    name = "awss3_getall"
    description = "Tool for awsS3 getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the awsS3 getAll operation."""
        ...
        if credentials:
            ...
            return f"Running awsS3 getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running awsS3 getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the awsS3 getAll operation asynchronously."""
