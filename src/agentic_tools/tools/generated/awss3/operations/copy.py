...
class Awss3CopyTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running awsS3 copy operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running awsS3 copy operation with default credentials and args: {kwargs}"
