...
class TapfiliateGetallToolInput(BaseModel):
...
class TapfiliateGetallTool(BaseTool):
    name = "tapfiliate_getall"
    description = "Tool for tapfiliate getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the tapfiliate getAll operation."""
        ...
        if credentials:
            ...
            return f"Running tapfiliate getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running tapfiliate getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the tapfiliate getAll operation asynchronously."""
