...
class TapfiliateRemoveToolInput(BaseModel):
...
class TapfiliateRemoveTool(BaseTool):
    name = "tapfiliate_remove"
    description = "Tool for tapfiliate remove operation - remove operation"
    ...
    def _run(self, **kwargs):
        """Run the tapfiliate remove operation."""
        ...
        if credentials:
            ...
            return f"Running tapfiliate remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running tapfiliate remove operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the tapfiliate remove operation asynchronously."""
