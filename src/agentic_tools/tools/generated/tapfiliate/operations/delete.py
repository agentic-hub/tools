...
class TapfiliateDeleteToolInput(BaseModel):
...
class TapfiliateDeleteTool(BaseTool):
    name = "tapfiliate_delete"
    description = "Tool for tapfiliate delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the tapfiliate delete operation."""
        ...
        if credentials:
            ...
            return f"Running tapfiliate delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running tapfiliate delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the tapfiliate delete operation asynchronously."""
