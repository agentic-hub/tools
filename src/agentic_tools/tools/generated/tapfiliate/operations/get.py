...
class TapfiliateGetToolInput(BaseModel):
...
class TapfiliateGetTool(BaseTool):
    name = "tapfiliate_get"
    description = "Tool for tapfiliate get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the tapfiliate get operation."""
        ...
        if credentials:
            ...
            return f"Running tapfiliate get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running tapfiliate get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the tapfiliate get operation asynchronously."""
