...
class TapfiliateApproveToolInput(BaseModel):
...
class TapfiliateApproveTool(BaseTool):
    name = "tapfiliate_approve"
    description = "Tool for tapfiliate approve operation - approve operation"
    ...
    def _run(self, **kwargs):
        """Run the tapfiliate approve operation."""
        ...
        if credentials:
            ...
            return f"Running tapfiliate approve operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running tapfiliate approve operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the tapfiliate approve operation asynchronously."""
