...
class BoxShareTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running box share operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running box share operation with default credentials and args: {kwargs}"
