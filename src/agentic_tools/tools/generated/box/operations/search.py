...
class BoxSearchToolInput(BaseModel):
...
class BoxSearchTool(BaseTool):
    name = "box_search"
    description = "Tool for box search operation - search operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running box search operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running box search operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the box search operation asynchronously."""
