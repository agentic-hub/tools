...
class QuickbooksGetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running quickbooks getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running quickbooks getAll operation with default credentials and args: {kwargs}"
