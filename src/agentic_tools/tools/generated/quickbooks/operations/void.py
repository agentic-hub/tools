...
class QuickbooksVoidToolInput(BaseModel):
    ...
    invoiceId: Optional[str] = Field(None, description="The ID of the invoice to void")
    ...
    paymentId: Optional[str] = Field(None, description="The ID of the payment to void")
...
class QuickbooksVoidTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running quickbooks void operation with args: {kwargs}"
