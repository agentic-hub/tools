...
class QuickbooksVoidToolInput(BaseModel):
    ...
    invoice_id: Optional[str] = Field(None, description="The ID of the invoice to void")
    ...
    payment_id: Optional[str] = Field(None, description="The ID of the payment to void")
...
class QuickbooksVoidTool(BaseTool):
    name = "quickbooks_void"
    description = "Tool for quickbooks void operation - void operation"
    ...
    def _run(self, **kwargs):
        """Run the quickbooks void operation."""
        ...
        if credentials:
            ...
            return f"Running quickbooks void operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running quickbooks void operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the quickbooks void operation asynchronously."""
