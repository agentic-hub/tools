...
class QuickbooksGetreportTool(BaseTool):
    name = "quickbooks_getreport"
    description = "Tool for quickbooks getReport operation - getReport operation"
    ...
    def _run(self, **kwargs):
        """Run the quickbooks getReport operation."""
        ...
        if credentials:
            ...
            return f"Running quickbooks getReport operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running quickbooks getReport operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the quickbooks getReport operation asynchronously."""
