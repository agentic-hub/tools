...
class QuickbooksGetToolInput(BaseModel):
    ...
    invoice_id: Optional[str] = Field(None, description="The ID of the invoice to retrieve")
    ...
    payment_id: Optional[str] = Field(None, description="The ID of the payment to retrieve")
    vendor_id: Optional[str] = Field(None, description="The ID of the vendor to retrieve")
    item_id: Optional[str] = Field(None, description="The ID of the item to retrieve")
    return_all: Optional[bool] = Field(None, description="Whether to return all results or only up to a given limit")
    email: Optional[str] = Field(None, description="The email of the recipient of the estimate")
    purchase_id: Optional[str] = Field(None, description="The ID of the purchase to retrieve")
    ...
    bill_id: Optional[str] = Field(None, description="The ID of the bill to retrieve")
    ...
    estimate_id: Optional[str] = Field(None, description="The ID of the estimate to retrieve")
    file_name: Optional[str] = Field(None, description="Name of the file that will be downloaded")


class QuickbooksGetTool(BaseTool):
    name = "quickbooks_get"
    description = "Tool for quickbooks get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the quickbooks get operation."""
        ...
        if credentials:
            ...
            return f"Running quickbooks get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running quickbooks get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the quickbooks get operation asynchronously."""
