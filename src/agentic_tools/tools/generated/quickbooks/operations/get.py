...
class QuickbooksGetToolInput(BaseModel):
    ...
    invoiceId: Optional[str] = Field(None, description="The ID of the invoice to retrieve")
    ...
    paymentId: Optional[str] = Field(None, description="The ID of the payment to retrieve")
    vendorId: Optional[str] = Field(None, description="The ID of the vendor to retrieve")
    itemId: Optional[str] = Field(None, description="The ID of the item to retrieve")
    returnAll: Optional[bool] = Field(None, description="Whether to return all results or only up to a given limit")
    email: Optional[str] = Field(None, description="The email of the recipient of the estimate")
    purchaseId: Optional[str] = Field(None, description="The ID of the purchase to retrieve")
    ...
    billId: Optional[str] = Field(None, description="The ID of the bill to retrieve")
    Line: Optional[List[Any]] = Field(None, description="Individual line item of a transaction")
    filters: Optional[Dict[str, Any]] = Field(None, description="Filters")
    additionalFields: Optional[Dict[str, Any]] = Field(None, description="Additional Fields")
    resource: Optional[str] = Field(None, description="Resource")
    estimateId: Optional[str] = Field(None, description="The ID of the estimate to retrieve")
...
class QuickbooksGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running quickbooks get operation with args: {kwargs}"
