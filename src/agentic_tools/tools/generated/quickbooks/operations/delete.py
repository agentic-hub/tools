...
class QuickbooksDeleteTool(BaseTool):
    name = "quickbooks_delete"
    description = "Tool for quickbooks delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the quickbooks delete operation."""
        ...
        if credentials:
            ...
            return f"Running quickbooks delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running quickbooks delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the quickbooks delete operation asynchronously."""
