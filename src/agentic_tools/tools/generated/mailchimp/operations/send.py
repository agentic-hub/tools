...
class MailchimpSendToolInput(BaseModel):
...
class MailchimpSendTool(BaseTool):
    name = "mailchimp_send"
    description = "Tool for mailchimp send operation - send operation"
    ...
    def _run(self, **kwargs):
        """Run the mailchimp send operation."""
        ...
        if credentials:
            ...
            return f"Running mailchimp send operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mailchimp send operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the mailchimp send operation asynchronously."""
