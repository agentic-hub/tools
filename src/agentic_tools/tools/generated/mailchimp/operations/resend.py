...
class MailchimpResendTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mailchimp resend operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mailchimp resend operation with default credentials and args: {kwargs}"
