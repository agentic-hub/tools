...
class MailchimpReplicateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mailchimp replicate operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mailchimp replicate operation with default credentials and args: {kwargs}"
