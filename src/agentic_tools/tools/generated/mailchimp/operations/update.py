...
class MailchimpUpdateToolInput(BaseModel):
...
class MailchimpUpdateTool(BaseTool):
    name = "mailchimp_update"
    description = "Tool for mailchimp update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the mailchimp update operation."""
        ...
        if credentials:
            ...
            return f"Running mailchimp update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mailchimp update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the mailchimp update operation asynchronously."""
