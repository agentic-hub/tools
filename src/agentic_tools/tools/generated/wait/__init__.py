...
class WaitToolkit(AgenticHubToolkit):
    """Toolkit for interacting with wait."""

    def __init__(self, credentials: Optional[WaitCredentials] = None):
        """Initialize the wait toolkit with optional credentials.

        Args:
            credentials: WaitCredentials object containing authentication credentials
        """
