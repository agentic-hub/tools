...
class ElasticsecurityGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running elasticSecurity get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running elasticSecurity get operation with default credentials and args: {kwargs}"
