...
class ElasticsecurityGetstatusTool(BaseTool):
    name = "elasticsecurity_getstatus"
    description = "Tool for elasticSecurity getStatus operation - getStatus operation"
    ...
    def _run(self, **kwargs):
        """Run the elasticSecurity getStatus operation."""
        ...
        if credentials:
            ...
            return f"Running elasticSecurity getStatus operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running elasticSecurity getStatus operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the elasticSecurity getStatus operation asynchronously."""
