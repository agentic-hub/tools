...
class ZammadGetallTool(BaseTool):
    name = "zammad_getall"
    description = "Tool for zammad getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the zammad getAll operation."""
        ...
        if credentials:
            ...
            return f"Running zammad getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zammad getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the zammad getAll operation asynchronously."""
