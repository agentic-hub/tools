...
class ZammadUpdateTool(BaseTool):
    name = "zammad_update"
    description = "Tool for zammad update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the zammad update operation."""
        ...
        if credentials:
            ...
            return f"Running zammad update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zammad update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the zammad update operation asynchronously."""
