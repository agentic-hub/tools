...
class ZammadGetselfTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running zammad getSelf operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running zammad getSelf operation with default credentials and args: {kwargs}"
