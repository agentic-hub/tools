...
class MicrosoftonedriveDownloadToolInput(BaseModel):
...
class MicrosoftonedriveDownloadTool(BaseTool):
    name = "microsoftonedrive_download"
    description = "Tool for microsoftOneDrive download operation - download operation"
    ...
    def _run(self, **kwargs):
        """Run the microsoftOneDrive download operation."""
        ...
        if credentials:
            ...
            return f"Running microsoftOneDrive download operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftOneDrive download operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the microsoftOneDrive download operation asynchronously."""
