...
class MicrosoftonedriveRenameTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running microsoftOneDrive rename operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftOneDrive rename operation with default credentials and args: {kwargs}"
