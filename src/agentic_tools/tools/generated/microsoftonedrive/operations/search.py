...
class MicrosoftonedriveSearchTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running microsoftOneDrive search operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running microsoftOneDrive search operation with default credentials and args: {kwargs}"
