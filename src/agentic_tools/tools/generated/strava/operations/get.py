...
class StravaGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running strava get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running strava get operation with default credentials and args: {kwargs}"
