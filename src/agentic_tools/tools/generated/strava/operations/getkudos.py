...
class StravaGetkudosTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running strava getKudos operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running strava getKudos operation with default credentials and args: {kwargs}"
