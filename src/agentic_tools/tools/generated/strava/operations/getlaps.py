...
class StravaGetlapsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running strava getLaps operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running strava getLaps operation with default credentials and args: {kwargs}"
