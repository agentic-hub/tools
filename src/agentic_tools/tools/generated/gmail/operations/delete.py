...
class GmailDeleteTool(BaseTool):
    name = "gmail_delete"
    description = "Tool for gmail delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the gmail delete operation."""
        ...
        if credentials:
            ...
            return f"Running gmail delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running gmail delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the gmail delete operation asynchronously."""
