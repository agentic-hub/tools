...
class GmailSendTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running gmail send operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running gmail send operation with default credentials and args: {kwargs}"
