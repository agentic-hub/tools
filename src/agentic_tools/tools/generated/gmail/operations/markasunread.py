...
class GmailMarkasunreadTool(BaseTool):
    name = "gmail_markasunread"
    description = "Tool for gmail markAsUnread operation - markAsUnread operation"
    ...
    def _run(self, **kwargs):
        """Run the gmail markAsUnread operation."""
        ...
        if credentials:
            ...
            return f"Running gmail markAsUnread operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running gmail markAsUnread operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the gmail markAsUnread operation asynchronously."""
