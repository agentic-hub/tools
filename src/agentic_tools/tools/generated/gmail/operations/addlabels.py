...
class GmailAddlabelsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running gmail addLabels operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running gmail addLabels operation with default credentials and args: {kwargs}"
