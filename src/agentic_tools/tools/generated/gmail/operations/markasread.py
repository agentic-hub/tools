...
class GmailMarkasreadToolInput(BaseModel):
...
class GmailMarkasreadTool(BaseTool):
    name = "gmail_markasread"
    description = "Tool for gmail markAsRead operation - markAsRead operation"
    ...
    def _run(self, **kwargs):
        """Run the gmail markAsRead operation."""
        ...
        if credentials:
            ...
            return f"Running gmail markAsRead operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running gmail markAsRead operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the gmail markAsRead operation asynchronously."""
