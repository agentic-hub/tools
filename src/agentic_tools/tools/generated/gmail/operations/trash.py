...
class GmailTrashTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running gmail trash operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running gmail trash operation with default credentials and args: {kwargs}"
