...
class DiscourseRemoveTool(BaseTool):
    name = "discourse_remove"
    description = "Tool for discourse remove operation - remove operation"
    ...
    def _run(self, **kwargs):
        """Run the discourse remove operation."""
        ...
        if credentials:
            ...
            return f"Running discourse remove operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running discourse remove operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the discourse remove operation asynchronously."""
