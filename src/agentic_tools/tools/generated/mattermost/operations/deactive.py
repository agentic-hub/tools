...
class MattermostDeactiveTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mattermost deactive operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mattermost deactive operation with default credentials and args: {kwargs}"
