...
class MattermostPostephemeralTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mattermost postEphemeral operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mattermost postEphemeral operation with default credentials and args: {kwargs}"
