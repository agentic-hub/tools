...
class MattermostRestoreToolInput(BaseModel):
    ...
    channel_id: Optional[str] = Field(None, description="The ID of the channel to restore")
...
class MattermostRestoreTool(BaseTool):
    name = "mattermost_restore"
    description = "Tool for mattermost restore operation - restore operation"
    ...
    def _run(self, **kwargs):
        """Run the mattermost restore operation."""
        ...
        if credentials:
            ...
            return f"Running mattermost restore operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mattermost restore operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the mattermost restore operation asynchronously."""
