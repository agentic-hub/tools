...
class MattermostStatisticsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mattermost statistics operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mattermost statistics operation with default credentials and args: {kwargs}"
