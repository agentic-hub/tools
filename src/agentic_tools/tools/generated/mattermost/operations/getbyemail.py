...
class MattermostGetbyemailToolInput(BaseModel):
...
class MattermostGetbyemailTool(BaseTool):
    name = "mattermost_getbyemail"
    description = "Tool for mattermost getByEmail operation - getByEmail operation"
    ...
    def _run(self, **kwargs):
        """Run the mattermost getByEmail operation."""
        ...
        if credentials:
            ...
            return f"Running mattermost getByEmail operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mattermost getByEmail operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the mattermost getByEmail operation asynchronously."""
