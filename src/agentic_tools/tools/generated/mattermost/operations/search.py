...
class MattermostSearchTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mattermost search operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mattermost search operation with default credentials and args: {kwargs}"
