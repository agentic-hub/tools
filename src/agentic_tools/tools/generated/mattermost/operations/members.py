...
class MattermostMembersTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mattermost members operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mattermost members operation with default credentials and args: {kwargs}"
