...
class DiscordGetallTool(BaseTool):
    name = "discord_getall"
    description = "Tool for discord getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the discord getAll operation."""
        ...
        if credentials:
            ...
            return f"Running discord getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running discord getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the discord getAll operation asynchronously."""
