...
class DiscordUpdateTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running discord update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running discord update operation with default credentials and args: {kwargs}"
