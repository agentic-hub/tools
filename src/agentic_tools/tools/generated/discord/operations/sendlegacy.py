...
class DiscordSendlegacyToolInput(BaseModel):
...
class DiscordSendlegacyTool(BaseTool):
    name = "discord_sendlegacy"
    description = "Tool for discord sendLegacy operation - sendLegacy operation"
    ...
    def _run(self, **kwargs):
        """Run the discord sendLegacy operation."""
        ...
        if credentials:
            ...
            return f"Running discord sendLegacy operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running discord sendLegacy operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the discord sendLegacy operation asynchronously."""
