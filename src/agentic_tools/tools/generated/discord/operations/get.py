...
class DiscordGetToolInput(BaseModel):
...
class DiscordGetTool(BaseTool):
    name = "discord_get"
    description = "Tool for discord get operation - get operation"
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running discord get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running discord get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the discord get operation asynchronously."""
