...
class DiscordDeletemessageTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running discord deleteMessage operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running discord deleteMessage operation with default credentials and args: {kwargs}"
