...
class SalesmateUpdateTool(BaseTool):
    name = "salesmate_update"
    description = "Tool for salesmate update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the salesmate update operation."""
        ...
        if credentials:
            ...
            return f"Running salesmate update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesmate update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesmate update operation asynchronously."""
