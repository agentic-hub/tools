...
class SalesmateGetallTool(BaseTool):
    name = "salesmate_getall"
    description = "Tool for salesmate getAll operation - getAll operation"
    ...
    def _run(self, **kwargs):
        """Run the salesmate getAll operation."""
        ...
        if credentials:
            ...
            return f"Running salesmate getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running salesmate getAll operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the salesmate getAll operation asynchronously."""
