...
class GoogledriveGetToolInput(BaseModel):
    ...
    drive_id: Optional[Dict[str, Any]] = Field(None, description="The shared drive to get")
...
class GoogledriveGetTool(BaseTool):
    name = "googledrive_get"
    description = "Tool for googleDrive get operation - get operation"
    ...
    def _run(self, **kwargs):
        """Run the googleDrive get operation."""
        ...
        if credentials:
            ...
            return f"Running googleDrive get operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleDrive get operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the googleDrive get operation asynchronously."""
