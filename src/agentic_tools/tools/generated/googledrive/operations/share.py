...
class GoogledriveShareToolInput(BaseModel):
    ...
    file_id: Optional[Dict[str, Any]] = Field(None, description="The file to share")
    ...
    folder_no_root_id: Optional[Dict[str, Any]] = Field(None, description="The folder to share")
...
class GoogledriveShareTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running googleDrive share operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleDrive share operation with default credentials and args: {kwargs}"
