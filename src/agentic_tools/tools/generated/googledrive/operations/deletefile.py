...
class GoogledriveDeletefileTool(BaseTool):
    ...
    description = "Tool for googleDrive deleteFile operation - deleteFile operation"
    ...
    def _run(self, **kwargs):
        """Run the googleDrive deleteFile operation."""
        ...
        if credentials:
            ...
            return f"Running googleDrive deleteFile operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleDrive deleteFile operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the googleDrive deleteFile operation asynchronously."""
