...
class GoogledriveDeletedriveTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running googleDrive deleteDrive operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleDrive deleteDrive operation with default credentials and args: {kwargs}"
