...
class GoogledriveDownloadToolInput(BaseModel):
    ...
    file_id: Optional[Dict[str, Any]] = Field(None, description="The file to download")
...
class GoogledriveDownloadTool(BaseTool):
    name = "googledrive_download"
    description = "Tool for googleDrive download operation - download operation"
    ...
    def _run(self, **kwargs):
        """Run the googleDrive download operation."""
        ...
        if credentials:
            ...
            return f"Running googleDrive download operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleDrive download operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the googleDrive download operation asynchronously."""
