...
class GoogledriveMoveTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running googleDrive move operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleDrive move operation with default credentials and args: {kwargs}"
