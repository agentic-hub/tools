...
class MauticUpdateToolInput(BaseModel):
...
class MauticUpdateTool(BaseTool):
    name = "mautic_update"
    description = "Tool for mautic update operation - update operation"
    ...
    def _run(self, **kwargs):
        """Run the mautic update operation."""
        ...
        if credentials:
            ...
            return f"Running mautic update operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mautic update operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the mautic update operation asynchronously."""
