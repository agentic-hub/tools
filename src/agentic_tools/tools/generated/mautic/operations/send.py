...
class MauticSendTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mautic send operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mautic send operation with default credentials and args: {kwargs}"
