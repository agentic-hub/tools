...
class MauticDeleteTool(BaseTool):
    name = "mautic_delete"
    description = "Tool for mautic delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the mautic delete operation."""
        ...
        if credentials:
            ...
            return f"Running mautic delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mautic delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the mautic delete operation asynchronously."""
