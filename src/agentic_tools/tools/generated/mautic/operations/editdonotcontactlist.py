...
class MauticEditdonotcontactlistTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mautic editDoNotContactList operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mautic editDoNotContactList operation with default credentials and args: {kwargs}"
