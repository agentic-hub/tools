...
class MauticSendemailTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running mautic sendEmail operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running mautic sendEmail operation with default credentials and args: {kwargs}"
