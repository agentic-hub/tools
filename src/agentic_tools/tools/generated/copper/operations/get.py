...
class CopperGetToolInput(BaseModel):
    ...
    opportunityId: Optional[str] = Field(None, description="ID of the opportunity to retrieve")
    ...
    projectId: Optional[str] = Field(None, description="ID of the project to retrieve")
    ...
    companyId: Optional[str] = Field(None, description="ID of the company to retrieve")
...
class CopperGetTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        return f"Running copper get operation with args: {kwargs}"
