...
class GooglecalendarAvailabilityTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running googleCalendar availability operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running googleCalendar availability operation with default credentials and args: {kwargs}"
