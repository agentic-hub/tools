...
class ConvertkitAddsubscriberTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running convertKit addSubscriber operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running convertKit addSubscriber operation with default credentials and args: {kwargs}"
