...
class ConvertkitGetsubscriptionsTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running convertKit getSubscriptions operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running convertKit getSubscriptions operation with default credentials and args: {kwargs}"
