...
class AirtableDeleterecordTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running airtable deleteRecord operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running airtable deleteRecord operation with default credentials and args: {kwargs}"
