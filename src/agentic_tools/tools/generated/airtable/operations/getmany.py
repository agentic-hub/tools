...
class AirtableGetmanyTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running airtable getMany operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running airtable getMany operation with default credentials and args: {kwargs}"
