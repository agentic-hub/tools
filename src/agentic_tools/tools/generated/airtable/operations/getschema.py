...
class AirtableGetschemaToolInput(BaseModel):
...
class AirtableGetschemaTool(BaseTool):
    name = "airtable_getschema"
    description = "Tool for airtable getSchema operation - getSchema operation"
    ...
    def _run(self, **kwargs):
        """Run the airtable getSchema operation."""
        ...
        if credentials:
            ...
            return f"Running airtable getSchema operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running airtable getSchema operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the airtable getSchema operation asynchronously."""
