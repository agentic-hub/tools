...
class AirtableUpsertToolInput(BaseModel):
...
class AirtableUpsertTool(BaseTool):
    ...
    description = "Tool for airtable upsert operation - upsert operation"
    ...
    def _run(self, **kwargs):
        """Run the airtable upsert operation."""
        ...
        if credentials:
            ...
            return f"Running airtable upsert operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running airtable upsert operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the airtable upsert operation asynchronously."""
