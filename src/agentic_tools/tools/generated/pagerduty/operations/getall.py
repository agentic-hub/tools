...
class PagerdutyGetallTool(BaseTool):
    ...
    def _run(self, **kwargs):
        ...
        if credentials:
            ...
            return f"Running pagerDuty getAll operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running pagerDuty getAll operation with default credentials and args: {kwargs}"
