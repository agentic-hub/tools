...
class HighlevelDeleteTool(BaseTool):
    name = "highlevel_delete"
    description = "Tool for highLevel delete operation - delete operation"
    ...
    def _run(self, **kwargs):
        """Run the highLevel delete operation."""
        ...
        if credentials:
            ...
            return f"Running highLevel delete operation with custom credentials {safe_credentials} and args: {kwargs}"
        else:
            return f"Running highLevel delete operation with default credentials and args: {kwargs}"
    
    async def _arun(self, **kwargs):
        """Run the highLevel delete operation asynchronously."""
